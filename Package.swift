...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.12.2/LiterLlm-rs.artifactbundle.zip",
      checksum: "65f7a9f0b8f1aeb43185f787588d02deed7ea9a922d6e5b34859baf24accfc12"
    ),
