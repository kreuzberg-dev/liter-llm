...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.18.2/LiterLlm-rs.artifactbundle.zip",
      checksum: "874074110d88fb1ea8a0eab27255b9162ac219671d931fa240763b86830fbf73"
    ),
