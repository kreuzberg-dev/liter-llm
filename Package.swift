...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.18.3/LiterLlm-rs.artifactbundle.zip",
      checksum: "5db74ec42f536ac3a577083b53882775b797371cf3c1e23f210a2a3dc09f04f8"
    ),
