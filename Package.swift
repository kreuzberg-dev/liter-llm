...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.12.1/LiterLlm-rs.artifactbundle.zip",
      checksum: "81b70d49c19c473fe33dfd5be81bf156457036f3ca3c599f2a141215537f1a0f"
    ),
