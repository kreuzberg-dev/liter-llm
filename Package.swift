...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.19.1/LiterLlm-rs.artifactbundle.zip",
      checksum: "d4759bb18cf7b609a1279b8903b522545b62167f39e40e5f663ab2ff58b81d9d"
    ),
