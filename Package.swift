...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.18.0/LiterLlm-rs.artifactbundle.zip",
      checksum: "e30f36400101cbdcfc6fceee5a72e70dea3468232f0f00d0a3a03c091b9abc18"
    ),
