...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.11.5/LiterLlm-rs.artifactbundle.zip",
      checksum: "d260ed67750250c53d9b9252f1f66080bcaa1551f721fb479253a3925eb96f81"
    ),
