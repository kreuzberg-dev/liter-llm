...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v1.19.2/LiterLlm-rs.artifactbundle.zip",
      checksum: "b864874dcda6dfbbc5c311d6ce61d1f6f7963bb4217f51db475f533a87038d22"
    ),
