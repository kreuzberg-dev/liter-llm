...
// alef:hash:6f21cbdb0ed70d41311836b7ab0f4c548a3657424ce9074af59d8ef0f4e7edd8
...
describe('image-generate', () => {
  it('edge_image_b64_response: Image generation returning base64-encoded data instead of URL', async () => {
    ...
    expect(result.data["0"].b64Json != null).toBe(true);
  });
  ...
  it('edge_image_multiple_n: Image generation requesting multiple images with n=3', async () => {
    ...
    expect(result.data["0"].url != null).toBe(true);
    expect(result.data["1"].url != null).toBe(true);
    expect(result.data["2"].url != null).toBe(true);
  });
