...
// alef:hash:1d3ab272c0bc3f0c06cb8a88f892d5b45492d8b5f0c9f35d1c7c6df2c0d565aa
...
async fn test_custom_base_url() {
    ...
    assert_eq!(_choices_0_message_content, r#"Hi there!"#, "equals assertion failed");
    assert_eq!(_choices_0_finish_reason, r#"stop"#, "equals assertion failed");
    assert_eq!(result.model.to_string(), r#"local-model"#, "equals assertion failed");
}
...
async fn test_local_provider_llamacpp() {
    ...
    assert_eq!(
        _choices_0_message_content, r#"Hi there! I'm running locally."#,
        "equals assertion failed"
    );
    assert_eq!(_choices_0_finish_reason, r#"stop"#, "equals assertion failed");
    assert_eq!(result.model.to_string(), r#"my-model"#, "equals assertion failed");
}
...
async fn test_local_provider_ollama() {
    ...
    assert_eq!(
        _choices_0_message_content, r#"Hello! How can I help you today?"#,
        "equals assertion failed"
    );
    assert_eq!(_choices_0_finish_reason, r#"stop"#, "equals assertion failed");
    assert_eq!(result.model.to_string(), r#"qwen2:0.5b"#, "equals assertion failed");
}
...
async fn test_local_provider_vllm() {
    ...
    assert_eq!(
        _choices_0_message_content, r#"Hello! How may I assist you?"#,
        "equals assertion failed"
    );
    assert_eq!(_choices_0_finish_reason, r#"stop"#, "equals assertion failed");
    assert_eq!(
