...
// alef:hash:ba2f6d93c4a7c535c161707c00b21f9be8b71322b4a320d096e709bcbedc2762
// To regenerate: alef generate
// To verify freshness: alef verify

import { describe, expect, it } from "vitest";
import { createClient, WasmChatCompletionRequest, WasmCreateFileRequest, WasmChatCompletionTool, WasmFunctionDefinition, WasmStreamOptions, WasmFilePurpose } from "@xberg-io/liter-llm-wasm";
...
describe("files", () => {
	...
	it("error_file_bad_purpose: 400 Bad Request when uploading a file with invalid purpose", async () => {
		...
		await expect(async () => {
			await client.createFile((() => { const _u0 = WasmCreateFileRequest.default(); _u0.file = "data.jsonl"; _u0.purpose = WasmFilePurpose.InvalidPurpose; return _u0; })());
		}).rejects.toSatisfy((error) => {
				const _message = error instanceof Error ? error.message : String(error);
				const _name = error instanceof Error ? error.name : "";
