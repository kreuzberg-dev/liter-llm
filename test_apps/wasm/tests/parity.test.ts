...
// alef:hash:d39b2cf05533044d51a88a482f237704bd912c2afbe130c2aeb31d3c76f0a0f2
...
describe("parity", () => {
	...
	it("api_surface_parity: Canonical API surface definition for cross-binding parity verification", async () => {
		...
		const result = await client.chat((() => { const _u0 = WasmChatCompletionRequest.default(); _u0.messages = [{ content: "Hello", role: "user" }]; _u0.model = "gpt-4o"; return _u0; })());
