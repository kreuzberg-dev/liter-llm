...
// alef:hash:af0a87ce35cc0c64cca5714776c665ba0f7541e141674f8596b239f4b03e5949
...
describe("custom_provider", () => {
	...
	it("provider_auth: Tests custom provider with custom auth header", async () => {
		...
		const result = await client.chat((() => { const _u0 = WasmChatCompletionRequest.default(); _u0.messages = [{ content: "Hello", role: "user" }]; _u0.model = "my-auth-model-v1"; return _u0; })());
	...
	it("register_provider: Tests that a custom provider can be registered and routes requests", async () => {
		...
		const result = await client.chat((() => { const _u0 = WasmChatCompletionRequest.default(); _u0.messages = [{ content: "Hello", role: "user" }]; _u0.model = "my-model-v1"; return _u0; })());
    expect(result).toBeDefined();
