...
// alef:hash:fdbb261124fa0608b642f46db82dc4e7ac61727461a32191f5f2647028f58fc9
...
describe("responses", () => {
	...
	it("smoke_response_with_tools: Response that includes tool call output items", async () => {
		...
		const result = await client.createResponse((() => { const _u0 = WasmCreateResponseRequest.default(); _u0.input = "What is the weather in San Francisco?"; _u0.model = "gpt-4o"; _u0.tools = [(() => { const _u1 = WasmResponseTool.default(); _u1.description = "Get current weather for a location"; _u1.name = "get_weather"; _u1.parameters = { properties: { location: { type: "string" } }, required: ["location"], type: "object" }; _u1.toolType = "function"; return _u1; })()]; return _u0; })());
    {
        const _v = result.id;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
