...
<!-- alef:hash:60e95e72afda44a3e1de24137d70e593d199f6c444167c957ff8f4af11e7c6a6 -->
...
Universal LLM API client for Java. Access 165 LLM providers through a single type-safe interface with Foreign Function & Memory API integration, async support, and native performance.
...
```gradle
implementation 'io.xberg.literllm:liter-llm:1.18.4'
```
