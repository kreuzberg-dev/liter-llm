...
// alef:hash:8daeb2b7f390363a3c7d0d1d0d036babb1c38e00215d79630008dc99ebf72ed9
...
public final class LiterLlm {
    ...
    public static void recordCostUsd(
        ...
        java.util.Objects.requireNonNull(system, "system must not be null");
        java.util.Objects.requireNonNull(model, "model must not be null");
        java.util.Objects.requireNonNull(operation, "operation must not be null");
        java.util.Objects.requireNonNull(costUsd, "costUsd must not be null");
        LiterLlmRs.recordCostUsd(system, model, operation, costUsd);
    }
