...
// alef:hash:adfe392dcf731cfd748b8e669b79970aa2bd75464bb042e0895bc4eaf0162c9c
...
public final class LiterLlmRs {
    ...
    public static boolean unregisterCustomProvider(final String name) throws LiterLlmRsException {
        try (var arena = Arena.ofShared();
            ...
            var primitiveResult = (long) NativeLib.LITERLLM_UNREGISTER_CUSTOM_PROVIDER.invoke(cname);
            checkLastError();
