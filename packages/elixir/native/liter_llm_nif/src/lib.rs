...
// alef:hash:5b8d70c1f8b2d838354a28c2b053b11f8630a38946aa5441354b69a8baa6ac69
...
impl AssistantMessage {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            reasoning_content: opts.get("reasoning_content").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl CatalogRefreshConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            source_url: opts.get("source_url").and_then(|t| t.decode().ok()).unwrap_or(
                "https://github.com/xberg-io/liter-llm/releases/download/model-catalog/catalog.json".to_string(),
            ),
            ttl_seconds: opts.get("ttl_seconds").and_then(|t| t.decode().ok()).unwrap_or(86400),
            cache_path: opts.get("cache_path").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl ChatCompletionRequest {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            modalities: opts.get("modalities").and_then(|t| t.decode().ok()),
            logprobs: opts.get("logprobs").and_then(|t| t.decode().ok()),
            top_logprobs: opts.get("top_logprobs").and_then(|t| t.decode().ok()),
            max_completion_tokens: opts.get("max_completion_tokens").and_then(|t| t.decode().ok()),
            service_tier: opts.get("service_tier").and_then(|t| t.decode().ok()),
            store: opts.get("store").and_then(|t| t.decode().ok()),
            metadata: opts.get("metadata").and_then(|t| t.decode().ok()),
            prediction: opts.get("prediction").and_then(|t| t.decode().ok()),
            audio: opts.get("audio").and_then(|t| t.decode().ok()),
            web_search_options: opts.get("web_search_options").and_then(|t| t.decode().ok()),
...
impl DecodedDataUrl {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            mime: opts.get("mime").and_then(|t| t.decode().ok()).unwrap_or_default(),
            data: opts.get("data").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
pub struct DefaultClient {
    inner: Arc<std::sync::RwLock<liter_llm::client::DefaultClient>>,
}
...
impl LlmConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            in_flight_limit: opts.get("in_flight_limit").and_then(|t| t.decode().ok()),
...
impl LlmInFlightLimitConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            max_in_flight: opts.get("max_in_flight").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl ModelInfo {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            input_cost_per_token: opts
                .get("input_cost_per_token")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            output_cost_per_token: opts
                .get("output_cost_per_token")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            cache_read_input_token_cost: opts.get("cache_read_input_token_cost").and_then(|t| t.decode().ok()),
            cache_creation_input_token_cost: opts
                .get("cache_creation_input_token_cost")
                .and_then(|t| t.decode().ok()),
            input_cost_per_audio_token: opts.get("input_cost_per_audio_token").and_then(|t| t.decode().ok()),
            output_cost_per_audio_token: opts.get("output_cost_per_audio_token").and_then(|t| t.decode().ok()),
            output_cost_per_reasoning_token: opts
                .get("output_cost_per_reasoning_token")
                .and_then(|t| t.decode().ok()),
            max_tokens: opts.get("max_tokens").and_then(|t| t.decode().ok()),
            max_input_tokens: opts.get("max_input_tokens").and_then(|t| t.decode().ok()),
            max_output_tokens: opts.get("max_output_tokens").and_then(|t| t.decode().ok()),
            mode: opts.get("mode").and_then(|t| t.decode().ok()),
            supports_vision: opts.get("supports_vision").and_then(|t| t.decode().ok()),
            supports_function_calling: opts.get("supports_function_calling").and_then(|t| t.decode().ok()),
            supports_reasoning: opts.get("supports_reasoning").and_then(|t| t.decode().ok()),
            supports_structured_output: opts.get("supports_structured_output").and_then(|t| t.decode().ok()),
            supports_audio_input: opts.get("supports_audio_input").and_then(|t| t.decode().ok()),
            supports_audio_output: opts.get("supports_audio_output").and_then(|t| t.decode().ok()),
            supports_prompt_caching: opts.get("supports_prompt_caching").and_then(|t| t.decode().ok()),
            tiers: opts.get("tiers").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl ProviderCapabilities {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            vision: opts.get("vision").and_then(|t| t.decode().ok()).unwrap_or_default(),
            reasoning: opts.get("reasoning").and_then(|t| t.decode().ok()).unwrap_or_default(),
            structured_output: opts
                .get("structured_output")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            function_calling: opts
                .get("function_calling")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            audio_in: opts.get("audio_in").and_then(|t| t.decode().ok()).unwrap_or_default(),
            audio_out: opts.get("audio_out").and_then(|t| t.decode().ok()).unwrap_or_default(),
            video_in: opts.get("video_in").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
pub struct SingleflightResult {
    inner: Arc<std::sync::RwLock<liter_llm::tower::SingleflightResult>>,
}

// SAFETY: See gen_opaque_resource in alef-backend-rustler for rationale.

impl std::panic::RefUnwindSafe for SingleflightResult {}

impl rustler::Resource for SingleflightResult {}
...
impl WaitForBatchConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            initial_interval_secs: opts
                .get("initial_interval_secs")
                .and_then(|t| t.decode().ok())
                .unwrap_or(5.0),
            max_interval_secs: opts
                .get("max_interval_secs")
                .and_then(|t| t.decode().ok())
                .unwrap_or(60.0),
            backoff_multiplier: opts
...
#[module = "LiterLlm.AssistantContent"]
pub struct AssistantContent {
    pub r#type: String,
    pub text: Option<String>,
    pub parts: Option<Vec<AssistantPart>>,
}
...
pub struct EmbeddingInput {
    ...
    pub multimodal: Option<Vec<EmbeddingContentPart>>,
}
...
pub fn count_request_tokens(model: String, req: Option<String>) -> Result<usize, String> {
    let req_core: Option<liter_llm::types::ChatCompletionRequest> = req
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `count_request_tokens`: {error}"))?;
...
pub fn decode_data_url(url: String) -> Option<DecodedDataUrl> {
    liter_llm::image::decode_data_url(&url).map(|v| v.into())
}
...
/// ```
#[rustler::nif]
pub fn encode_data_url(bytes: rustler::Binary, mime: Option<String>) -> String {
    liter_llm::image::encode_data_url(bytes.as_slice(), mime.as_deref())
}
...
pub fn model_info(model: String) -> Option<ModelInfo> {
    liter_llm::model_info(&model).map(|v| v.into())
}
...
/// availability.
#[rustler::nif(schedule = "DirtyCpu")]
pub fn refresh_catalog_async(config: Option<String>) -> Result<RefreshOutcome, String> {
    let config_core: Option<liter_llm::cost::refresh::CatalogRefreshConfig> = config
        .map(|s| serde_json::from_str::<liter_llm::cost::refresh::CatalogRefreshConfig>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `config` for `refresh_catalog_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        liter_llm::cost::refresh::refresh_catalog(config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
#[rustler::nif]
pub fn assistantmessage_text(obj: AssistantMessage) -> Option<String> {
    liter_llm::types::AssistantMessage::from(obj).text()
}
...
#[rustler::nif]
pub fn assistantmessage_refusal_text(obj: AssistantMessage) -> Option<String> {
    liter_llm::types::AssistantMessage::from(obj)
        .refusal_text()
        .map(|v| v.into())
}
...
#[rustler::nif]
pub fn assistantmessage_reasoning_text(obj: AssistantMessage) -> Option<String> {
    liter_llm::types::AssistantMessage::from(obj)
        .reasoning_text()
        .map(|v| v.into())
}
...
#[rustler::nif]
pub fn assistantmessage_output_images(obj: AssistantMessage) -> Vec<ImageUrl> {
    liter_llm::types::AssistantMessage::from(obj)
        .output_images()
        .into_iter()
        .map(Into::into)
...
#[rustler::nif]
pub fn assistantmessage_output_audio(obj: AssistantMessage) -> Vec<AudioContent> {
    liter_llm::types::AssistantMessage::from(obj)
        .output_audio()
        .into_iter()
        .map(Into::into)
...
#[rustler::nif]
pub fn catalogrefreshconfig_default() -> CatalogRefreshConfig {
...
pub fn defaultclient_chat_async(
    ...
    let req_core: Option<liter_llm::types::ChatCompletionRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::types::ChatCompletionRequest>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `defaultclient_chat_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .chat(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_embed_async(
    ...
    let req_core: Option<liter_llm::types::EmbeddingRequest> = req
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `defaultclient_embed_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .embed(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_image_generate_async(
    ...
    let req_core: Option<liter_llm::types::CreateImageRequest> = req
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `req` for `defaultclient_image_generate_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_speech_async(
    ...
    let req_core: Option<liter_llm::types::CreateSpeechRequest> = req
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `defaultclient_speech_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .speech(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.to_vec())
...
pub fn defaultclient_transcribe_async(
    ...
    let req_core: Option<liter_llm::types::CreateTranscriptionRequest> = req
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `req` for `defaultclient_transcribe_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .transcribe(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_moderate_async(
    ...
    let req_core: Option<liter_llm::types::ModerationRequest> = req
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `req` for `defaultclient_moderate_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .moderate(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_rerank_async(
    ...
    let req_core: Option<liter_llm::types::RerankRequest> = req
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `defaultclient_rerank_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .rerank(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_search_async(
    ...
    let req_core: Option<liter_llm::types::SearchRequest> = req
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `defaultclient_search_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .search(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_ocr_async(
    ...
    let req_core: Option<liter_llm::types::OcrRequest> = req
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `req` for `defaultclient_ocr_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .ocr(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_create_file_async(
    ...
    let req_core: Option<liter_llm::types::CreateFileRequest> = req
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `req` for `defaultclient_create_file_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .create_file(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_list_files_async(
    ...
    let query_core: Option<liter_llm::types::FileListQuery> = query
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `query` for `defaultclient_list_files_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_create_batch_async(
    ...
    let req_core: Option<liter_llm::types::CreateBatchRequest> = req
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `req` for `defaultclient_create_batch_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .create_batch(req_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_list_batches_async(
    ...
    let query_core: Option<liter_llm::types::BatchListQuery> = query
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `query` for `defaultclient_list_batches_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
...
#[cfg(any(feature = "native-http", feature = "wasm-http"))]
#[rustler::nif(schedule = "DirtyCpu")]
pub fn defaultclient_fetch_batch_for_polling_async(
    resource: rustler::ResourceArc<DefaultClient>,
    batch_id: String,
) -> Result<BatchObject, String> {
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
...
/// ```
#[rustler::nif(schedule = "DirtyCpu")]
pub fn defaultclient_wait_for_batch_async(
    resource: rustler::ResourceArc<DefaultClient>,
    batch_id: String,
    config: Option<String>,
) -> Result<BatchObject, String> {
    let config_core: Option<liter_llm::client::WaitForBatchConfig> = config
        .map(|s| serde_json::from_str::<liter_llm::client::WaitForBatchConfig>(&s))
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `config` for `defaultclient_wait_for_batch_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
                ...
                let result = rt
                    .block_on(async {
                        resource
                            ...
                            .read()
                            .unwrap_or_else(|e| e.into_inner())
                            .wait_for_batch(&batch_id, config_core.unwrap_or_default())
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into())
...
pub fn defaultclient_create_response_async(
    ...
    let req_core: Option<liter_llm::types::CreateResponseRequest> = req
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `req` for `defaultclient_create_response_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
...
#[rustler::nif]
pub fn llmconfig_providers(obj: LlmConfig) -> Vec<LlmProviderConfig> {
    liter_llm::client::LlmConfig::from(obj)
        .providers()
        .iter()
        .cloned()
        .map(Into::into)
...
#[rustler::nif]
pub fn waitforbatchconfig_default() -> WaitForBatchConfig {
...
impl From<liter_llm::types::AssistantContent> for AssistantContent {
    fn from(val: liter_llm::types::AssistantContent) -> Self {
        match val {
            liter_llm::types::AssistantContent::Text(_0) => Self {
                r#type: "Text".to_string(),
                text: Some(_0),
                ..Default::default()
            },
            liter_llm::types::AssistantContent::Parts(_0) => Self {
                r#type: "Parts".to_string(),
...
impl From<AssistantContent> for liter_llm::types::AssistantContent {
    fn from(val: AssistantContent) -> Self {
        match val.r#type.as_str() {
            "Text" => liter_llm::types::AssistantContent::Text(val.text.unwrap_or_default()),
            "Parts" => liter_llm::types::AssistantContent::Parts(
...
impl From<AuthHeaderFormat> for liter_llm::provider::custom::AuthHeaderFormat {
    fn from(val: AuthHeaderFormat) -> Self {
        match val.r#type.as_str() {
            ...
            "ApiKey" => liter_llm::provider::custom::AuthHeaderFormat::ApiKey(val.api_key.unwrap_or_default()),
...
impl From<liter_llm::types::EmbeddingInput> for EmbeddingInput {
    fn from(val: liter_llm::types::EmbeddingInput) -> Self {
        match val {
            ...
            liter_llm::types::EmbeddingInput::Multimodal(_0) => Self {
                r#type: "Multimodal".to_string(),
                multimodal: Some(_0.into_iter().map(Into::into).collect()),
                ..Default::default()
            },
        }
    }
...
impl From<EmbeddingInput> for liter_llm::types::EmbeddingInput {
    fn from(val: EmbeddingInput) -> Self {
        match val.r#type.as_str() {
            "Single" => liter_llm::types::EmbeddingInput::Single(val.single.unwrap_or_default()),
            "Multiple" => liter_llm::types::EmbeddingInput::Multiple(val.multiple.unwrap_or_default().into()),
            "Multimodal" => liter_llm::types::EmbeddingInput::Multimodal(
                val.multimodal.unwrap_or_default().into_iter().map(Into::into).collect(),
            ),
            _ => Default::default(),
        }
    }
...
impl From<ModerationInput> for liter_llm::types::ModerationInput {
    fn from(val: ModerationInput) -> Self {
        match val.r#type.as_str() {
            "Single" => liter_llm::types::ModerationInput::Single(val.single.unwrap_or_default()),
...
impl From<liter_llm::types::RerankDocument> for RerankDocument {
    fn from(val: liter_llm::types::RerankDocument) -> Self {
        match val {
            liter_llm::types::RerankDocument::Text(_0) => Self::Text { _0: _0.to_string() },
...
impl From<StopSequence> for liter_llm::types::StopSequence {
    fn from(val: StopSequence) -> Self {
        match val.r#type.as_str() {
            "Single" => liter_llm::types::StopSequence::Single(val.single.unwrap_or_default()),
...
impl From<UserContent> for liter_llm::types::UserContent {
    fn from(val: UserContent) -> Self {
        match val.r#type.as_str() {
            "Text" => liter_llm::types::UserContent::Text(val.text.unwrap_or_default()),
...
/// Convert a `liter_llm::cost::refresh::CatalogRefreshError` error to a Rustler error string.
#[allow(dead_code)]
fn catalog_refresh_error_to_rustler_err(e: liter_llm::cost::refresh::CatalogRefreshError) -> String {
    e.to_string()
}
...
pub fn llm_in_flight_limit_config_from_json(json: String) -> Result<LlmInFlightLimitConfig, String> {
    serde_json::from_str::<liter_llm::client::LlmInFlightLimitConfig>(&json)
        .map(LlmInFlightLimitConfig::from)
        .map_err(|e| e.to_string())
}
...
fn on_load(env: rustler::Env, _info: rustler::Term) -> bool {
    ...
    env.register::<SingleflightResult>()
        .expect("Failed to register resource type SingleflightResult");
