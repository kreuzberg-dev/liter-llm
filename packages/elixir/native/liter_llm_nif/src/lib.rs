...
// alef:hash:24f828f7d192a31dbba5338e5b350f3b613382f935615f6c84332ce4ae4a681c
...
pub fn defaultclient_speech_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.speech(req.into()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.to_vec())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_ocr_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.ocr(req.into()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_create_file_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.create_file(req.into()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_retrieve_file_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.retrieve_file(&file_id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_delete_file_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.delete_file(&file_id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_list_files_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.list_files(query.map(Into::into)).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_file_content_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.file_content(&file_id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.to_vec())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_create_batch_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.create_batch(req.into()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_retrieve_batch_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.retrieve_batch(&batch_id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_list_batches_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.list_batches(query.map(Into::into)).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_cancel_batch_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.cancel_batch(&batch_id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_create_response_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.create_response(req.into()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_retrieve_response_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.retrieve_response(&id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_cancel_response_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.cancel_response(&id).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
impl From<liter_llm::types::ChatCompletionRequest> for ChatCompletionRequest {
    fn from(val: liter_llm::types::ChatCompletionRequest) -> Self {
        Self {
            ...
            presence_penalty: val.presence_penalty,
            frequency_penalty: val.frequency_penalty,
            logit_bias: val.logit_bias.as_ref().map(|m| format!("{m:?}")),
            user: val.user,
            tools: val.tools.map(|v| v.into_iter().map(Into::into).collect()),
            tool_choice: val.tool_choice.map(Into::into),
            parallel_tool_calls: val.parallel_tool_calls,
