...
# alef:hash:3932754a7a2f1d3a06384d11e134a00f4bd6a9141ef2bfd88ace12553125e209
...
defmodule LiterLlm do
  ...
  def defaultclient_chat_async(obj, req) do
    LiterLlm.Native.defaultclient_chat_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_embed_async(obj, req) do
    LiterLlm.Native.defaultclient_embed_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_image_generate_async(obj, req) do
    LiterLlm.Native.defaultclient_image_generate_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_speech_async(obj, req) do
    LiterLlm.Native.defaultclient_speech_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_transcribe_async(obj, req) do
    LiterLlm.Native.defaultclient_transcribe_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_moderate_async(obj, req) do
    LiterLlm.Native.defaultclient_moderate_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_rerank_async(obj, req) do
    LiterLlm.Native.defaultclient_rerank_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_search_async(obj, req) do
    LiterLlm.Native.defaultclient_search_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_ocr_async(obj, req) do
    LiterLlm.Native.defaultclient_ocr_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_create_file_async(obj, req) do
    LiterLlm.Native.defaultclient_create_file_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_list_files_async(obj, query) do
    LiterLlm.Native.defaultclient_list_files_async(
      obj.ref,
      cond do
        is_nil(query) -> nil
        is_binary(query) -> query
        true -> Jason.encode!(query)
      end
    )
  end
  ...
  def defaultclient_create_batch_async(obj, req) do
    LiterLlm.Native.defaultclient_create_batch_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def defaultclient_list_batches_async(obj, query) do
    LiterLlm.Native.defaultclient_list_batches_async(
      obj.ref,
      cond do
        is_nil(query) -> nil
        is_binary(query) -> query
  ...
  def defaultclient_wait_for_batch_async(obj, batch_id, config) do
    LiterLlm.Native.defaultclient_wait_for_batch_async(
      obj.ref,
      batch_id,
      cond do
        is_nil(config) -> nil
  ...
  def defaultclient_create_response_async(obj, req) do
    LiterLlm.Native.defaultclient_create_response_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
