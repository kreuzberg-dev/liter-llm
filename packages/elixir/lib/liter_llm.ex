...
# alef:hash:78d8fc9e28a66c8c80671e8b8f17ebff66b617440e2671fae794e318379181f2
...
defmodule LiterLlm do
  ...
  @doc "Record the estimated USD cost of a completion."
  @spec record_cost_usd(String.t(), String.t(), String.t(), float()) :: nil
  def record_cost_usd(system, model, operation, cost_usd) do
    LiterLlm.Native.record_cost_usd(system, model, operation, cost_usd)
  end
  ...
  def defaultclient_chat_async(obj, req) do
    LiterLlm.Native.defaultclient_chat_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_embed_async(obj, req) do
    LiterLlm.Native.defaultclient_embed_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_list_models_async(obj) do
    LiterLlm.Native.defaultclient_list_models_async(obj.ref)
  end

  def defaultclient_image_generate_async(obj, req) do
    LiterLlm.Native.defaultclient_image_generate_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_speech_async(obj, req) do
    LiterLlm.Native.defaultclient_speech_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_transcribe_async(obj, req) do
    LiterLlm.Native.defaultclient_transcribe_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_moderate_async(obj, req) do
    LiterLlm.Native.defaultclient_moderate_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_rerank_async(obj, req) do
    LiterLlm.Native.defaultclient_rerank_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_search_async(obj, req) do
    LiterLlm.Native.defaultclient_search_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_ocr_async(obj, req) do
    LiterLlm.Native.defaultclient_ocr_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_create_file_async(obj, req) do
    LiterLlm.Native.defaultclient_create_file_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_retrieve_file_async(obj, file_id) do
    LiterLlm.Native.defaultclient_retrieve_file_async(obj.ref, file_id)
  end

  def defaultclient_delete_file_async(obj, file_id) do
    LiterLlm.Native.defaultclient_delete_file_async(obj.ref, file_id)
  end

  def defaultclient_list_files_async(obj, query) do
    LiterLlm.Native.defaultclient_list_files_async(obj.ref, (cond do is_nil(query) -> nil; is_binary(query) -> query; true -> Jason.encode!(query) end))
  end

  def defaultclient_file_content_async(obj, file_id) do
    LiterLlm.Native.defaultclient_file_content_async(obj.ref, file_id)
  end

  def defaultclient_create_batch_async(obj, req) do
    LiterLlm.Native.defaultclient_create_batch_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_retrieve_batch_async(obj, batch_id) do
    LiterLlm.Native.defaultclient_retrieve_batch_async(obj.ref, batch_id)
  end

  def defaultclient_list_batches_async(obj, query) do
    LiterLlm.Native.defaultclient_list_batches_async(obj.ref, (cond do is_nil(query) -> nil; is_binary(query) -> query; true -> Jason.encode!(query) end))
  end

  def defaultclient_cancel_batch_async(obj, batch_id) do
    LiterLlm.Native.defaultclient_cancel_batch_async(obj.ref, batch_id)
  end

  def defaultclient_fetch_batch_for_polling_async(obj, batch_id) do
    LiterLlm.Native.defaultclient_fetch_batch_for_polling_async(obj.ref, batch_id)
  end
  ...
  def defaultclient_wait_for_batch_async(obj, batch_id, config) do
    LiterLlm.Native.defaultclient_wait_for_batch_async(obj.ref, batch_id, (cond do is_nil(config) -> nil; is_binary(config) -> config; true -> Jason.encode!(config) end))
  end

  def defaultclient_create_response_async(obj, req) do
    LiterLlm.Native.defaultclient_create_response_async(obj.ref, (cond do is_nil(req) -> nil; is_binary(req) -> req; true -> Jason.encode!(req) end))
  end

  def defaultclient_retrieve_response_async(obj, response_id) do
    LiterLlm.Native.defaultclient_retrieve_response_async(obj.ref, response_id)
  end

  def defaultclient_cancel_response_async(obj, response_id) do
    LiterLlm.Native.defaultclient_cancel_response_async(obj.ref, response_id)
  end
end
