...
# alef:hash:38cdf4080f8993e99896bf3f42cf7f1f192098d74f5535346a1a8a2985faca33
...
defmodule LiterLlm.DefaultClient do
  ...
  def chat(obj, req) do
    Native.defaultclient_chat_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def chat_stream(obj, req) do
    case Native.defaultclient_chat_stream_start(
           obj.ref,
           cond do
             is_nil(req) -> nil
             is_binary(req) -> req
  ...
  def embed(obj, req) do
    Native.defaultclient_embed_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def image_generate(obj, req) do
    Native.defaultclient_image_generate_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def speech(obj, req) do
    Native.defaultclient_speech_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def transcribe(obj, req) do
    Native.defaultclient_transcribe_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def moderate(obj, req) do
    Native.defaultclient_moderate_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def rerank(obj, req) do
    Native.defaultclient_rerank_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def search(obj, req) do
    Native.defaultclient_search_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def ocr(obj, req) do
    Native.defaultclient_ocr_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def create_file(obj, req) do
    Native.defaultclient_create_file_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def list_files(obj, query) do
    Native.defaultclient_list_files_async(
      obj.ref,
      cond do
        is_nil(query) -> nil
  ...
  def create_batch(obj, req) do
    Native.defaultclient_create_batch_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
  ...
  def list_batches(obj, query) do
    Native.defaultclient_list_batches_async(
      obj.ref,
      cond do
        is_nil(query) -> nil
        is_binary(query) -> query
  ...
  def wait_for_batch(obj, batch_id, config) do
    Native.defaultclient_wait_for_batch_async(
      obj.ref,
      batch_id,
      cond do
        is_nil(config) -> nil
  ...
  def create_response(obj, req) do
    Native.defaultclient_create_response_async(
      obj.ref,
      cond do
        is_nil(req) -> nil
        is_binary(req) -> req
