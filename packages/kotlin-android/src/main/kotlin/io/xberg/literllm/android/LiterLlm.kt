...
// alef:hash:19c20ebf425107350b8fdcbcddfad0d51baf18bf25c6097c820fb77f8bec92f3
@file:Suppress(
...
object LiterLlm {
     ...
     */
    fun recordCostUsd(system: String, model: String, operation: String, costUsd: Double): Unit = LiterLlmBridge.nativeRecordCostUsd(system, model, operation, costUsd)
    /**
