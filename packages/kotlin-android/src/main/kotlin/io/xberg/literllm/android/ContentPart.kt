...
// alef:hash:a7771dea43c7407d9a4335b2e368d99460b3fbc40dd07c3e12e016aec99cbdb9
@file:Suppress(
    ...
    override fun deserialize(
        ...
        return when (tag) {
            ...
            "input_audio" -> ctx.readTreeAsValue<ContentPart.InputAudio>(payload, ContentPart.InputAudio::class.java)
                ...
                parser, "Unknown ContentPart tag", tag, ContentPart::class.java,
            )
        }
    }
}
...
private class ContentPartSerializer : com.fasterxml.jackson.databind.ser.std.StdSerializer<ContentPart>(ContentPart::class.java) {
    ...
    override fun serialize(
        ...
        val node: com.fasterxml.jackson.databind.node.ObjectNode = when (value) {
            is ContentPart.Text -> {
                @Suppress("UNCHECKED_CAST")
                val n = mapper.valueToTree<com.fasterxml.jackson.databind.node.ObjectNode>(value as ContentPart.Text) as com.fasterxml.jackson.databind.node.ObjectNode
                n.put("type", "text")
                n
            }
            is ContentPart.ImageUrl -> {
                @Suppress("UNCHECKED_CAST")
                val n = mapper.valueToTree<com.fasterxml.jackson.databind.node.ObjectNode>(value as ContentPart.ImageUrl) as com.fasterxml.jackson.databind.node.ObjectNode
                n.put("type", "image_url")
                n
            }
            is ContentPart.Document -> {
                @Suppress("UNCHECKED_CAST")
                val n = mapper.valueToTree<com.fasterxml.jackson.databind.node.ObjectNode>(value as ContentPart.Document) as com.fasterxml.jackson.databind.node.ObjectNode
                n.put("type", "document")
                n
            }
            is ContentPart.InputAudio -> {
                @Suppress("UNCHECKED_CAST")
                val n = mapper.valueToTree<com.fasterxml.jackson.databind.node.ObjectNode>(value as ContentPart.InputAudio) as com.fasterxml.jackson.databind.node.ObjectNode
