...
// alef:hash:5082925fc5d378eedbe86d1960a27d5cbdbcf14421286a2ec8391368bd0565cc
@file:Suppress(
...
object LiterLlmBridge {
    init { System.loadLibrary("literllm_jni") }
    ...
    @Throws(LiterLlmBridgeException::class)
    external fun nativeClearCatalogOverlay()
    ...
    @Throws(LiterLlmBridgeException::class)
    external fun nativeDecodeDataUrl(url: String): String?

    @Throws(LiterLlmBridgeException::class)
    external fun nativeEncodeDataUrl(bytes: String, mime: String): String

    @Throws(LiterLlmBridgeException::class)
    external fun nativeEnsureCryptoProvider()

    @Throws(LiterLlmBridgeException::class)
    external fun nativeInstallCatalogOverlayFromStr(catalogJson: String)

    @Throws(LiterLlmBridgeException::class)
    external fun nativeModelInfo(model: String): String?

    @Throws(LiterLlmBridgeException::class)
    external fun nativeRecordCostUsd(system: String, model: String, operation: String, costUsd: Double)

    @Throws(LiterLlmBridgeException::class)
    external fun nativeRefreshCatalog(config: String): String
    ...
    @Throws(LiterLlmBridgeException::class)
    external fun nativeDefaultClientFetchBatchForPolling(handle: Long, requestJson: String): String
    @Throws(LiterLlmBridgeException::class)
    ...
    @Throws(LiterLlmBridgeException::class)
    external fun nativeAssistantMessageOutputImages(selfJson: String): String
    @Throws(LiterLlmBridgeException::class)
    external fun nativeAssistantMessageOutputAudio(selfJson: String): String
    @Throws(LiterLlmBridgeException::class)
    external fun nativeLlmConfigProviders(selfJson: String): String
