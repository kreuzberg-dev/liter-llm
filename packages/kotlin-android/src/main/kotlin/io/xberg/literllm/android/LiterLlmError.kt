...
// alef:hash:e3270c636154d9190e133f851f4a225d259ff2cf2de35a330f91ce6066213583
@file:Suppress(
...
sealed class LiterLlmError(message: String) : Exception(message) {
    ...
    data class IdempotencyConflict(
        val key: String,
    ) : LiterLlmError("idempotency conflict: key '{key}' was already used with a different request body")
    data class IdempotencyInFlight(
        val key: String,
    ) : LiterLlmError("idempotency key '{key}' is currently in-flight; retry after the first request completes")
