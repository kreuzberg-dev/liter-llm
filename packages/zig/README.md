...
<!-- alef:hash:d7a717040faee0c7e149014573303d150669b90ddcaa9f40cd998339c08ab628 -->
...
```bash
zig fetch --save https://github.com/xberg-io/liter-llm/archive/refs/tags/v1.19.2.tar.gz
```
