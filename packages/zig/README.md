...
<!-- alef:hash:83b9c46e85d428faf3226a6f33dbd53b7814d82d2bae454d2f1b4c05fd42be99 -->
...
```bash
zig fetch --save https://github.com/xberg-io/liter-llm/archive/refs/tags/v1.19.1.tar.gz
```
