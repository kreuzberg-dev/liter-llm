...
// alef:hash:d5ac9c72e2483ad97dc02348e41395d7effe8c9ea2a17b2ab7f4167c9f439d7b
...
public sealed class ResponseFormatJsonConverter : JsonConverter<ResponseFormat>
{
    public override ResponseFormat Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return tagValue switch
        {
            ...
            "json_object" =>
                new ResponseFormat.JsonObject(),
            "json_schema" =>
                JsonSerializer.Deserialize<ResponseFormat.JsonSchema>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
