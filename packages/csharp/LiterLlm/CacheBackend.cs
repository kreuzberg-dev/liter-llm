...
// alef:hash:e3b88795336a6b9b27b346e3f1bcdb038c7b4dfb65fa872f1afde57ef222cb99
...
public sealed class CacheBackendJsonConverter : JsonConverter<CacheBackend>
{
    public override CacheBackend Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "memory" =>
                new CacheBackend.Memory(),
            "open_dal" =>
                JsonSerializer.Deserialize<CacheBackend.OpenDal>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
