...
// alef:hash:a4522b39752d3842a08d933ad0a5fb388c44809e73fe00ac2b7a6f2d8e0960b4
...
public sealed class OcrDocumentJsonConverter : JsonConverter<OcrDocument>
{
    public override OcrDocument Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "document_url" =>
                JsonSerializer.Deserialize<OcrDocument.Url>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "base64" =>
                JsonSerializer.Deserialize<OcrDocument.Base64>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
