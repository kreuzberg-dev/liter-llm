...
// alef:hash:7e1a2bf0895dfd3ddd0e264aa0e6b1f2de617511623e220ab4137b12ef42b2f0
...
public sealed class ContentPartJsonConverter : JsonConverter<ContentPart>
{
    public override ContentPart Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "text" =>
                JsonSerializer.Deserialize<ContentPart.Text>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "image_url" =>
                JsonSerializer.Deserialize<ContentPart.ImageUrl>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "document" =>
                JsonSerializer.Deserialize<ContentPart.Document>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "input_audio" =>
                JsonSerializer.Deserialize<ContentPart.InputAudio>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
