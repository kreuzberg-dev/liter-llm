...
// alef:hash:9c0e728dd1add61e6dad602a8a1c03bf191ddcaf5807f5b9092de33191b1b6c1
...
public sealed class AssistantPartJsonConverter : JsonConverter<AssistantPart>
{
    public override AssistantPart Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "text" =>
                JsonSerializer.Deserialize<AssistantPart.Text>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "refusal" =>
                JsonSerializer.Deserialize<AssistantPart.Refusal>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "output_image" =>
                JsonSerializer.Deserialize<AssistantPart.OutputImage>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "output_audio" =>
                JsonSerializer.Deserialize<AssistantPart.OutputAudio>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
