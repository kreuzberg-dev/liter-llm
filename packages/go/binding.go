...
// alef:hash:beeff822fd1dfa4307a6a6dcf015b86c341183790499b7dcdb02c3995741fb50
...
// If linking fails with `cannot find -lliter_llm_ffi`, run `go run <module>/cmd/setup`.

/*
#cgo CFLAGS: -I${SRCDIR}/include
#cgo CFLAGS: -DLITERLLM_FEATURE_FULL=1 -DLITERLLM_FEATURE_NATIVE_HTTP=1 -DLITERLLM_FEATURE_OPENDAL_CACHE=1 -DLITERLLM_FEATURE_TOKENIZER=1 -DLITERLLM_FEATURE_TOWER=1
...
// Sealed interface -- use one of AssistantPartText, AssistantPartRefusal, AssistantPartOutputImage, AssistantPartOutputAudio.
...
// Sealed interface -- use one of ContentPartText, ContentPartImageURL, ContentPartDocument, ContentPartInputAudio.
...
// EmbeddingContentPart content part in a multimodal embedding input.
// Variants: Text, ImageUrl, ImageBase64
// Sealed interface -- use one of EmbeddingContentPartText, EmbeddingContentPartImageURL, EmbeddingContentPartImageBase64.
type EmbeddingContentPart interface {
	isEmbeddingContentPart()
	Type() string
}

// EmbeddingContentPartText plain text.
type EmbeddingContentPartText struct {
	Text string `json:"text"`
}

func (EmbeddingContentPartText) isEmbeddingContentPart() {}
func (EmbeddingContentPartText) Type() string            { return "text" }
func (v EmbeddingContentPartText) MarshalJSON() ([]byte, error) {
	type aux struct {
		Type string `json:"type"`
		Text string `json:"text"`
	}
...
// EmbeddingContentPartImageURL image identified by a data URL or HTTP/HTTPS URL.
type EmbeddingContentPartImageURL struct {
	ImageURL ImageURL `json:"image_url"`
}

func (EmbeddingContentPartImageURL) isEmbeddingContentPart() {}
func (EmbeddingContentPartImageURL) Type() string            { return "image_url" }
func (v EmbeddingContentPartImageURL) MarshalJSON() ([]byte, error) {
	type aux struct {
		Type     string   `json:"type"`
		ImageURL ImageURL `json:"image_url"`
	}
...
// EmbeddingContentPartImageBase64 image encoded as a complete data URL.
type EmbeddingContentPartImageBase64 struct {
	ImageBase64 string `json:"image_base64"`
}

func (EmbeddingContentPartImageBase64) isEmbeddingContentPart() {}
func (EmbeddingContentPartImageBase64) Type() string            { return "image_base64" }
func (v EmbeddingContentPartImageBase64) MarshalJSON() ([]byte, error) {
	type aux struct {
		Type        string `json:"type"`
		ImageBase64 string `json:"image_base64"`
	}
...
// UnmarshalEmbeddingContentPart decodes JSON data into the appropriate concrete EmbeddingContentPart variant.
func UnmarshalEmbeddingContentPart(data []byte) (EmbeddingContentPart, error) {
	var wire struct {
		Type string `json:"type"`
	}
	if err := json.Unmarshal(data, &wire); err != nil {
	...
	switch wire.Type {
	case "text":
		var v EmbeddingContentPartText
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "image_url":
		var v EmbeddingContentPartImageURL
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "image_base64":
		var v EmbeddingContentPartImageBase64
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	}
	return nil, fmt.Errorf("unknown EmbeddingContentPart type: %q", wire.Type)
}
...
// EmbeddingInput text, texts, or multimodal content to embed.
// Variants: Single, Multiple, Multimodal
...
const (
	...
	// ReasoningEffortMinimal ReasoningEffortMinimal is the Minimal variant of ReasoningEffort.
	ReasoningEffortMinimal ReasoningEffort = "minimal"
	// ReasoningEffortMax ReasoningEffortMax is the Max variant of ReasoningEffort.
...
// Sealed interface -- use one of ResponseFormatText, ResponseFormatJSONObject, ResponseFormatJSONSchema.
...
func (s *ChatCompletionRequest) UnmarshalJSON(data []byte) error {
	...
	s.Logprobs = raw.Logprobs
	s.TopLogprobs = raw.TopLogprobs
	s.MaxCompletionTokens = raw.MaxCompletionTokens
	s.ServiceTier = raw.ServiceTier
	s.Store = raw.Store
	s.Metadata = raw.Metadata
	s.Prediction = raw.Prediction
	s.Audio = raw.Audio
	s.WebSearchOptions = raw.WebSearchOptions
...
// CreateResponseRequest request to create a response via the OpenAI Responses API (`POST /responses`).
//
// # Provider support
//
...
// InFlightLimitConfig configuration for the global per-client in-flight request limit.
type InFlightLimitConfig struct {
	// Maximum simultaneously outstanding provider requests. `None` means unlimited.
	MaxInFlight *uint `json:"max_in_flight,omitempty"`
}
...
// LlmConfig canonical configuration for an LLM client.
//
...
type LlmConfig struct {
	...
	InFlightLimit *LlmInFlightLimitConfig `json:"in_flight_limit,omitempty"`
...
// LlmInFlightLimitConfig global per-client in-flight provider request limit.
type LlmInFlightLimitConfig struct {
	// Maximum simultaneously outstanding provider requests. `None` means unlimited.
	MaxInFlight *uint `json:"max_in_flight,omitempty"`
}

// LlmProviderConfig custom provider configuration entry.
...
type RateLimitConfig struct {
	...
	Window DurationMillis `json:"window"`
}
...
type SingleflightResult struct {
	ptr C.LITERLLMSingleflightResult
}

// Free releases the resources held by this handle.
func (h *SingleflightResult) Free() {
	if h.ptr != 0 {
		C.literllm_singleflight_result_free(h.ptr)
		h.ptr = 0
	}
}
...
type SpecificToolChoice struct {
	...
	ChoiceType ToolType `json:"type"`
	// The specific function to invoke.
	Function *SpecificFunction `json:"function,omitempty"`
}
...
type WaitForBatchConfig struct {
	...
	MaxIntervalSecs float64 `json:"max_interval_secs"`
...
func CompletionCost(model string, promptTokens uint64, completionTokens uint64) *float64 {
	...
	if C.literllm_completion_cost_has_result(cModel, cPromptTokens, cCompletionTokens) != 1 {
		return nil
	}
...
func CompletionCostWithCache(model string, promptTokens uint64, cachedTokens uint64, completionTokens uint64) *float64 {
	...
	if C.literllm_completion_cost_with_cache_has_result(cModel, cPromptTokens, cCachedTokens, cCompletionTokens) != 1 {
		return nil
	}
...
func CreateClient(apiKey string, baseURL *string, timeoutSecs *uint64, maxRetries *uint32, modelHint *string) (*DefaultClient, error) {
	...
	return &DefaultClient{ptr: ptr}, nil
}
...
// RecordCostUsd record the estimated USD cost of a completion.
//
...
func RecordCostUsd(system string, model string, operation string, costUsd float64) {
	...
	cCostUsd := C.double(float64(costUsd))

	C.literllm_record_cost_usd(cSystem, cModel, cOperation, cCostUsd)
}
...
// ReasoningText return the model's reasoning/thinking tokens, if the provider returned any.
func (r *AssistantMessage) ReasoningText() (*string, error) {
	jsonBytesRecv, err := json.Marshal(r)
	if err != nil {
		return nil, fmt.Errorf("failed to marshal receiver: %w", err)
	}
	...
	defer C.literllm_assistant_message_free(cRecv)
	ptr := C.literllm_assistant_message_reasoning_text(cRecv)
	return func() *string {
		if ptr == nil {
			return nil
		}
...
func (h *DefaultClient) Chat(req ChatCompletionRequest) (*ChatCompletionResponse, error) {
	...
	ptr := C.literllm_default_client_chat(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) ChatStream(req ChatCompletionRequest) (<-chan ChatCompletionChunk, error) {
	...
	handle := C.literllm_default_client_chat_stream_start(h.ptr, cReq)
	if handle == 0 {
		if err := lastError(); err != nil {
			return nil, err
		}
...
func (h *DefaultClient) Embed(req EmbeddingRequest) (*EmbeddingResponse, error) {
	...
	ptr := C.literllm_default_client_embed(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) ListModels() (*ModelsListResponse, error) {
	ptr := C.literllm_default_client_list_models(h.ptr)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) ImageGenerate(req CreateImageRequest) (*ImagesResponse, error) {
	...
	ptr := C.literllm_default_client_image_generate(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) Speech(req CreateSpeechRequest) ([]byte, error) {
	...
	rc := C.literllm_default_client_speech(h.ptr, cReq, &outPtr, &outLen, &outCap)
	if rc != 0 {
	...
	defer C.literllm_free_bytes(outPtr, outLen, outCap)
...
func (h *DefaultClient) Transcribe(req CreateTranscriptionRequest) (*TranscriptionResponse, error) {
	...
	ptr := C.literllm_default_client_transcribe(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) Moderate(req ModerationRequest) (*ModerationResponse, error) {
	...
	ptr := C.literllm_default_client_moderate(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) Rerank(req RerankRequest) (*RerankResponse, error) {
	...
	ptr := C.literllm_default_client_rerank(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) Search(req SearchRequest) (*SearchResponse, error) {
	...
	ptr := C.literllm_default_client_search(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) Ocr(req OcrRequest) (*OcrResponse, error) {
	...
	ptr := C.literllm_default_client_ocr(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) CreateFile(req CreateFileRequest) (*FileObject, error) {
	...
	ptr := C.literllm_default_client_create_file(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) RetrieveFile(fileID string) (*FileObject, error) {
	...
	ptr := C.literllm_default_client_retrieve_file(h.ptr, cFileID)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_file_object_free(ptr)
...
func (h *DefaultClient) DeleteFile(fileID string) (*DeleteResponse, error) {
	...
	ptr := C.literllm_default_client_delete_file(h.ptr, cFileID)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) ListFiles(query *FileListQuery) (*FileListResponse, error) {
	...
	ptr := C.literllm_default_client_list_files(h.ptr, cQuery)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) FileContent(fileID string) ([]byte, error) {
	...
	var outPtr *C.uint8_t
	var outLen, outCap C.uintptr_t
	rc := C.literllm_default_client_file_content(h.ptr, cFileID, &outPtr, &outLen, &outCap)
	if rc != 0 {
		return nil, lastError()
	}
	if outPtr == nil {
...
func (h *DefaultClient) CreateBatch(req CreateBatchRequest) (*BatchObject, error) {
	...
	ptr := C.literllm_default_client_create_batch(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) RetrieveBatch(batchID string) (*BatchObject, error) {
	...
	ptr := C.literllm_default_client_retrieve_batch(h.ptr, cBatchID)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_batch_object_free(ptr)
...
func (h *DefaultClient) ListBatches(query *BatchListQuery) (*BatchListResponse, error) {
	...
	ptr := C.literllm_default_client_list_batches(h.ptr, cQuery)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) CancelBatch(batchID string) (*BatchObject, error) {
	...
	ptr := C.literllm_default_client_cancel_batch(h.ptr, cBatchID)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_batch_object_free(ptr)
...
func (h *DefaultClient) FetchBatchForPolling(batchID string) (*BatchObject, error) {
	...
	ptr := C.literllm_default_client_fetch_batch_for_polling(h.ptr, cBatchID)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_batch_object_free(ptr)
...
func (h *DefaultClient) WaitForBatch(batchID string, config WaitForBatchConfig) (*BatchObject, error) {
	...
	ptr := C.literllm_default_client_wait_for_batch(h.ptr, cBatchID, cConfig)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_batch_object_free(ptr)
...
func (h *DefaultClient) CreateResponse(req CreateResponseRequest) (*ResponseObject, error) {
	...
	ptr := C.literllm_default_client_create_response(h.ptr, cReq)
	if err := lastError(); err != nil {
		return nil, err
	}
...
func (h *DefaultClient) RetrieveResponse(responseID string) (*ResponseObject, error) {
	...
	ptr := C.literllm_default_client_retrieve_response(h.ptr, cResponseID)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_response_object_free(ptr)
...
func (h *DefaultClient) CancelResponse(responseID string) (*ResponseObject, error) {
	...
	ptr := C.literllm_default_client_cancel_response(h.ptr, cResponseID)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.literllm_response_object_free(ptr)
