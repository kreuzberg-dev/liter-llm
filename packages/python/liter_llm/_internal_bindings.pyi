...
# alef:hash:7ecdbd3fd45af220775cab5b7438024e583e2db1f56f8c4cb4af95c7f73bfc8c
...
class DefaultClient:
    ...
    async def create_file(self, req: str) -> str: ...
    async def retrieve_file(self, file_id: str) -> str: ...
    async def delete_file(self, file_id: str) -> str: ...
    async def list_files(self, query: str | None = None) -> str: ...
    async def file_content(self, file_id: str) -> bytes: ...
    async def create_batch(self, req: str) -> str: ...
    async def retrieve_batch(self, batch_id: str) -> str: ...
    async def list_batches(self, query: str | None = None) -> str: ...
    async def cancel_batch(self, batch_id: str) -> str: ...
    async def create_response(self, req: str) -> str: ...
