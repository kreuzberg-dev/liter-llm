...
// alef:hash:9b550d62edade4076367ff6e6bc5ab9d99ee7773863d5a19fad76f287103772c
...
impl ModerationRequest {
    pub fn __construct(input: String, model: Option<String>) -> Self {
        Self { input, model }
    }
}
...
impl CustomProviderConfig {
    pub fn __construct(name: String, base_url: String, auth_header: String, model_prefixes: Vec<String>) -> Self {
        Self {
            name,
            base_url,
            auth_header,
...
impl From<UserMessage> for liter_llm::types::UserMessage {
    fn from(val: UserMessage) -> Self {
        Self {
            content: match val.content.as_str() {
                "Text" => liter_llm::types::UserContent::Text(Default::default()),
                "Parts" => liter_llm::types::UserContent::Parts(Default::default()),
                _ => liter_llm::types::UserContent::Text(Default::default()),
            },
            name: val.name,
        }
    }
    ...
    fn from(val: ChatCompletionTool) -> Self {
        Self {
            tool_type: match val.tool_type.as_str() {
                ...
                _ => liter_llm::types::ToolType::Function,
            },
...
impl From<ChatCompletionRequest> for liter_llm::types::ChatCompletionRequest {
    fn from(val: ChatCompletionRequest) -> Self {
        Self {
            ...
            n: val.n,
            stream: val.stream,
            stop: val.stop.as_deref().map(|s| match s {
                "Single" => liter_llm::types::StopSequence::Single(Default::default()),
                "Multiple" => liter_llm::types::StopSequence::Multiple(Default::default()),
                _ => liter_llm::types::StopSequence::Single(Default::default()),
            }),
            ...
            tool_choice: val.tool_choice.as_deref().map(|s| match s {
                "Mode" => liter_llm::types::ToolChoice::Mode(Default::default()),
                "Specific" => liter_llm::types::ToolChoice::Specific(Default::default()),
                _ => liter_llm::types::ToolChoice::Mode(Default::default()),
            }),
            ...
            reasoning_effort: val.reasoning_effort.as_deref().map(|s| match s {
                ...
                _ => liter_llm::types::ReasoningEffort::Low,
            }),
    ...
    fn from(val: Choice) -> Self {
        Self {
            ...
            finish_reason: val.finish_reason.as_deref().map(|s| match s {
                ...
                "ToolCalls" => liter_llm::types::FinishReason::ToolCalls,
                "ContentFilter" => liter_llm::types::FinishReason::ContentFilter,
                "FunctionCall" => liter_llm::types::FinishReason::FunctionCall,
                "Other" => liter_llm::types::FinishReason::Other,
                _ => liter_llm::types::FinishReason::Stop,
            }),
        }
    }
}
...
impl From<EmbeddingRequest> for liter_llm::types::EmbeddingRequest {
    fn from(val: EmbeddingRequest) -> Self {
        Self {
            model: val.model,
            input: match val.input.as_str() {
                "Single" => liter_llm::types::EmbeddingInput::Single(Default::default()),
                "Multiple" => liter_llm::types::EmbeddingInput::Multiple(Default::default()),
                _ => liter_llm::types::EmbeddingInput::Single(Default::default()),
            },
...
impl From<ModerationRequest> for liter_llm::types::ModerationRequest {
    fn from(val: ModerationRequest) -> Self {
        Self {
            input: match val.input.as_str() {
                "Single" => liter_llm::types::ModerationInput::Single(Default::default()),
                "Multiple" => liter_llm::types::ModerationInput::Multiple(Default::default()),
                _ => liter_llm::types::ModerationInput::Single(Default::default()),
            },
            model: val.model,
        }
    }
        ...
        Self {
            ...
            documents: val
                ...
                .map(|s| match s.as_str() {
                    "Text" => liter_llm::types::RerankDocument::Text(Default::default()),
                    "Object" => liter_llm::types::RerankDocument::Object {
                        text: Default::default(),
                    },
                    _ => liter_llm::types::RerankDocument::Text(Default::default()),
                })
                .collect(),
            top_n: val.top_n,
    ...
    fn from(val: CreateFileRequest) -> Self {
        Self {
            ...
            purpose: match val.purpose.as_str() {
                ...
                "FineTune" => liter_llm::types::FilePurpose::FineTune,
                "Vision" => liter_llm::types::FilePurpose::Vision,
                _ => liter_llm::types::FilePurpose::Assistants,
            },
    ...
    fn from(val: BatchObject) -> Self {
        Self {
            ...
            status: match val.status.as_str() {
                ...
                "InProgress" => liter_llm::types::BatchStatus::InProgress,
                ...
                _ => liter_llm::types::BatchStatus::Validating,
            },
    ...
    fn from(val: CustomProviderConfig) -> Self {
        Self {
            ...
            auth_header: match val.auth_header.as_str() {
                ...
                "ApiKey" => liter_llm::provider::custom::AuthHeaderFormat::ApiKey(Default::default()),
                "None" => liter_llm::provider::custom::AuthHeaderFormat::None,
                _ => liter_llm::provider::custom::AuthHeaderFormat::Bearer,
            },
