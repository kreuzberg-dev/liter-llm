...
// alef:hash:eb985ab58dd8a16d846b57b1fd08fec70d2168c7c89a91ce38ff45872eba47b2
...
impl Message {
    ...
    #[php(getter)]
    pub fn get__0(&self) -> Option<SystemMessage> {
        self._0.clone()
    }
}
...
impl From<Message> for liter_llm::types::Message {
    fn from(val: Message) -> Self {
        match val.role_tag.as_str() {
            "system" => liter_llm::types::Message::System {
                _0: val._0.map(Into::into).unwrap_or_default(),
            },
            "user" => liter_llm::types::Message::User {
                _0: val._0.map(Into::into).unwrap_or_default(),
            },
            "assistant" => liter_llm::types::Message::Assistant {
                _0: val._0.map(Into::into).unwrap_or_default(),
            },
            "tool" => liter_llm::types::Message::Tool {
                _0: val._0.map(Into::into).unwrap_or_default(),
            },
            "developer" => liter_llm::types::Message::Developer {
                _0: val._0.map(Into::into).unwrap_or_default(),
            },
            "function" => liter_llm::types::Message::Function {
                _0: val._0.map(Into::into).unwrap_or_default(),
            },
            _ => liter_llm::types::Message::System { _0: Default::default() },
        }
    }
}
