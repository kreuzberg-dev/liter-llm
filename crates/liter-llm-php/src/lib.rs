...
// alef:hash:5989beebecbfe078e564862e34705437a14d40316b65ed3d048f19ccb38942aa
    ...
    fn from(val: OcrDocument) -> Self {
        match val.type_tag.as_str() {
            ...
            "base64" => liter_llm::types::OcrDocument::Base64 {
                data: val.data.map(Into::into).unwrap_or_default(),
                media_type: val.media_type.map(Into::into).unwrap_or_default(),
            },
