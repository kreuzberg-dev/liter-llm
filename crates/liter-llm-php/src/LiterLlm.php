...
// alef:hash:1115b90f0f3daf0bfb427ebc4527107ed68e8ce8de0716621a6f365e6f99b240
...
final class LiterLlm
{
     ...
     */
    public static function capabilities(string $provider_name): ProviderCapabilities
    {
    ...
    public static function completionCostWithCache(
        ...
        return \Liter\Llm\LiterLlmApi::completionCostWithCache(
            $model,
            $prompt_tokens,
            $cached_tokens,
            $completion_tokens,
    ...
    {
        \Liter\Llm\LiterLlmApi::recordCostUsd($system, $model, $operation, $cost_usd); // delegate to native extension class
    }
     ...
     * @throws \Liter\Llm\LiterLlmException
     */
    public static function refreshCatalog(CatalogRefreshConfig $config): string
    {
