...
<!-- alef:hash:1d4732ba1ab4d39552d24e92e96137684641e4858e08055421f59e92eaa3abd1 -->
...
Universal LLM API client for browsers and WebAssembly runtimes. Access 165 LLM providers with portable deployment across browsers, Deno, and Cloudflare Workers.
...
```bash
npm install @xberg-io/liter-llm-wasm
```
...
```bash
yarn add @xberg-io/liter-llm-wasm
```
