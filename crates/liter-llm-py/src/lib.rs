...
// alef:hash:3ccebc2b5b15e97e9f98910bee2035837d0b847a1b7c71d20bec80ed08a7b500
...
impl AssistantMessage {
    ...
    #[must_use]
    #[pyo3(signature = (content=None, name=None, tool_calls=None, refusal=None, function_call=None, reasoning_content=None))]
    #[new]
    pub fn new(
...
impl CatalogRefreshConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled=Self::default().enabled, source_url=Self::default().source_url, ttl_seconds=Self::default().ttl_seconds, cache_path=None))]
    #[new]
    pub fn new(enabled: bool, source_url: String, ttl_seconds: u64, cache_path: Option<String>) -> Self {
        Self {
            enabled,
            source_url,
            ttl_seconds,
...
impl ChatCompletionRequest {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (model=Self::default().model, messages=Self::default().messages, temperature=None, top_p=None, n=None, stream=None, stop=None, max_tokens=None, presence_penalty=None, frequency_penalty=None, logit_bias=None, user=None, tools=None, tool_choice=None, parallel_tool_calls=None, response_format=None, stream_options=None, seed=None, reasoning_effort=None, modalities=None, logprobs=None, top_logprobs=None, max_completion_tokens=None, service_tier=None, store=None, metadata=None, prediction=None, audio=None, web_search_options=None, extra_body=None))]
    #[new]
    pub fn new(
        model: String,
...
impl Choice {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (index=Self::default().index, message=None, finish_reason=None, logprobs=None))]
    #[new]
    pub fn new(
        index: u32,
...
impl CreateResponseRequest {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (model=Self::default().model, input=Self::default().input, instructions=None, tools=None, temperature=None, max_output_tokens=None, metadata=None, extra_body=None, stream=None))]
    #[new]
    pub fn new(
        model: String,
        input: String,
...
impl InFlightLimitConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (max_in_flight=None))]
    #[new]
...
impl LlmConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (model=Self::default().model, api_key=None, base_url=None, timeout_secs=None, max_retries=None, temperature=None, max_tokens=None, load_env=None, headers=None, providers=None, cache=None, budget=None, rate_limit=None, in_flight_limit=None, cost_tracking=None, tracing=None, cooldown_secs=None, health_check_secs=None, bedrock=None))]
    #[new]
    pub fn new(
        model: String,
...
impl ModelInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (input_cost_per_token=Self::default().input_cost_per_token, output_cost_per_token=Self::default().output_cost_per_token, tiers=Self::default().tiers, cache_read_input_token_cost=None, cache_creation_input_token_cost=None, input_cost_per_audio_token=None, output_cost_per_audio_token=None, output_cost_per_reasoning_token=None, max_tokens=None, max_input_tokens=None, max_output_tokens=None, mode=None, supports_vision=None, supports_function_calling=None, supports_reasoning=None, supports_structured_output=None, supports_audio_input=None, supports_audio_output=None, supports_prompt_caching=None))]
    #[new]
    pub fn new(
...
impl ModelTier {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (min_context_tokens=Self::default().min_context_tokens, input_cost_per_token=Self::default().input_cost_per_token, output_cost_per_token=Self::default().output_cost_per_token, cache_read_input_token_cost=None, cache_creation_input_token_cost=None, input_cost_per_audio_token=None, output_cost_per_audio_token=None, output_cost_per_reasoning_token=None))]
    #[new]
    pub fn new(
...
impl StreamDelta {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (role=None, content=None, tool_calls=None, function_call=None, refusal=None, reasoning_content=None))]
    #[new]
    pub fn new(
        role: Option<String>,
...
impl ToolMessage {
    ...
    #[new]
    pub fn new(content: UserContent, tool_call_id: String, name: Option<String>) -> Self {
        Self {
            content,
            tool_call_id,
            name,
...
const __ALEF_WIRE_JSON_SCHEMA_FORMAT: &[__AlefAlias] = &[];
...
impl AssistantContent {
    ...
    #[getter]
    fn text(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Text" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Text") {
    ...
    #[getter]
    fn parts(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Parts" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Parts") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
...
impl AssistantPart {
    ...
    #[getter]
    fn refusal(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn output_image(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn output_audio(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
...
impl AuthHeaderFormat {
    ...
    fn bearer(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Bearer" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Bearer") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
    ...
    #[getter]
    fn api_key(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "ApiKey" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("ApiKey") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
    ...
    #[getter]
    fn none(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "None" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("None") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
...
impl CacheBackend {
    ...
    #[getter]
    fn memory(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn open_dal(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
...
impl ContentPart {
    ...
    #[getter]
    fn image_url(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn document(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn input_audio(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    pub fn _factory_text(text: String) -> Self {
        Self {
            inner: liter_llm::types::ContentPart::Text { text },
        }
    }

    #[pyo3(name = "image_url")]
    #[staticmethod]
    pub fn _factory_image_url(py: Python<'_>, image_url: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::ContentPart::ImageUrl {
                image_url: __alef_coerce_dto(py, image_url, __ALEF_WIRE_IMAGE_URL)?,
            },
        })
    }
...
pub struct EmbeddingContentPart {
    pub(crate) inner: liter_llm::types::EmbeddingContentPart,
}
...
impl EmbeddingContentPart {
    ...
    fn new(
        ...
        // Accept three call shapes:
        //   EmbeddingContentPart("variant_name")                     -> unit variant
        //   EmbeddingContentPart({"type": "variant", ...})           -> dict positional
        //   EmbeddingContentPart(type="variant", field=...)          -> kwargs (idiomatic)
        // Kwargs are assembled into a Python dict and re-serialized via json so
        // serde_json can deserialize into the tagged enum.
        let json_str: String = if let Some(v) = value {
            if let Ok(s) = v.extract::<String>() {
                serde_json::to_string(&serde_json::json!({ "type": s })).map_err(|e| {
                    pyo3::exceptions::PyValueError::new_err(format!("Invalid EmbeddingContentPart: {e}"))
                })?
            } else {
                let json_mod = py.import("json")?;
                json_mod.call_method1("dumps", (v,))?.extract()?
            ...
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "EmbeddingContentPart() requires a positional value or keyword arguments".to_string(),
            ));
        };
        let inner: liter_llm::types::EmbeddingContentPart = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid EmbeddingContentPart: {e}")))?;
        Ok(Self { inner })
    }
    ...
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(&self.inner)
            ...
            .map_err(|e| {
                pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize EmbeddingContentPart: {e}"))
            })
    }
    ...
    #[getter]
    fn image_base64(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
        if tag_value != "image_base64" {
            return Ok(None);
        }
        let payload = json;
        let json_str = payload.to_string();
    ...
    pub fn _factory_text(text: String) -> Self {
        Self {
            inner: liter_llm::types::EmbeddingContentPart::Text { text },
        }
    }
    ...
    pub fn _factory_image_url(py: Python<'_>, image_url: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::EmbeddingContentPart::ImageUrl {
                image_url: __alef_coerce_dto(py, image_url, __ALEF_WIRE_IMAGE_URL)?,
            },
        })
    }

    #[pyo3(name = "image_base64")]
    #[staticmethod]
    pub fn _factory_image_base64(image_base64: String) -> Self {
        Self {
            inner: liter_llm::types::EmbeddingContentPart::ImageBase64 { image_base64 },
        }
    }
}
...
impl serde::Serialize for EmbeddingContentPart {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        self.inner.serialize(serializer)
    }
}
impl<'de> serde::Deserialize<'de> for EmbeddingContentPart {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = liter_llm::types::EmbeddingContentPart::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
impl EmbeddingInput {
    ...
    #[getter]
    fn single(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Single" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Single") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
    ...
    #[getter]
    fn multiple(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Multiple" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Multiple") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
    ...
    #[getter]
    fn multimodal(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Multimodal" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Multimodal") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
...
impl OcrDocument {
    ...
    #[getter]
    fn base64(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                ...
                3 => return Ok(Self::Minimal),
                4 => return Ok(Self::Max),
                _ => {}
            }
        }
...
impl RefreshOutcome {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            ...
            match s_lower.as_str() {
                ...
                "fromcache" => return Ok(Self::FromCache),
                "fetched" => return Ok(Self::Fetched),
                _ => {}
            }
        }
        // Try to extract as integer (by discriminant value)
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::Disabled),
                1 => return Ok(Self::FromCache),
                2 => return Ok(Self::Fetched),
                _ => {}
            }
        }
        let type_name = stringify!(RefreshOutcome);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
    ...
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize RefreshOutcome: {e}")))
    }
...
impl RerankDocument {
    ...
    #[getter]
    fn object(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let payload = match &json {
            serde_json::Value::String(value) if value == "Object" => serde_json::json!({}),
            serde_json::Value::Object(values) => match values.get("Object") {
                Some(value) => value.clone(),
                None => return Ok(None),
            },
            _ => return Ok(None),
...
impl ResponseFormat {
    ...
    #[getter]
    fn json_object(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn json_schema(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::PyAny>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "type";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[staticmethod]
    pub fn _factory_json_schema(py: Python<'_>, json_schema: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::ResponseFormat::JsonSchema {
                json_schema: __alef_coerce_dto(py, json_schema, __ALEF_WIRE_JSON_SCHEMA_FORMAT)?,
            },
        })
    }
}
...
impl ToolType {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            if matches!(s_lower.as_str(), "function") {
...
#[pyfunction]
#[pyo3(signature = ())]
pub fn clear_catalog_overlay(py: Python<'_>) -> () {
    py.detach(liter_llm::cost::refresh::clear_catalog_overlay)
}
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (catalog_json))]
pub fn install_catalog_overlay_from_str(py: Python<'_>, catalog_json: String) -> PyResult<()> {
    py.detach(|| liter_llm::cost::refresh::install_catalog_overlay_from_str(&catalog_json))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[pyfunction]
#[pyo3(signature = (model))]
pub fn model_info(py: Python<'_>, model: String) -> Option<ModelInfo> {
    py.detach(|| liter_llm::model_info(&model)).map(Into::into)
}

#[pyfunction]
#[pyo3(signature = (system, model, operation, cost_usd))]
pub fn record_cost_usd(py: Python<'_>, system: String, model: String, operation: String, cost_usd: f64) -> () {
    py.detach(|| liter_llm::tower::metrics::record_cost_usd(&system, &model, &operation, cost_usd))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (config))]
pub fn refresh_catalog<'py>(py: Python<'py>, config: CatalogRefreshConfig) -> PyResult<Bound<'py, PyAny>> {
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        let config_core: liter_llm::CatalogRefreshConfig = config.into();

        let result = liter_llm::cost::refresh::refresh_catalog(&config_core)
            .await
            .map_err(|e| PyErr::new::<PyRuntimeError, _>(e.to_string()))?;
        let wrapped_result: RefreshOutcome = RefreshOutcome::from(result);
        Ok(wrapped_result)
    })
}
...
// Error types
pyo3::create_exception!(_internal_bindings, CatalogRefreshError, pyo3::exceptions::PyException);
pyo3::create_exception!(_internal_bindings, DisabledError, CatalogRefreshError);
pyo3::create_exception!(_internal_bindings, InsecureUrlError, CatalogRefreshError);
pyo3::create_exception!(_internal_bindings, FetchError, CatalogRefreshError);
pyo3::create_exception!(_internal_bindings, ParseError, CatalogRefreshError);
pyo3::create_exception!(_internal_bindings, CacheError, CatalogRefreshError);

/// Convert a `liter_llm::CatalogRefreshError` error to a Python exception.
fn catalog_refresh_error_to_py_err(e: liter_llm::CatalogRefreshError) -> pyo3::PyErr {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        liter_llm::CatalogRefreshError::Disabled => DisabledError::new_err(msg),
        liter_llm::CatalogRefreshError::InsecureUrl { .. } => InsecureUrlError::new_err(msg),
        liter_llm::CatalogRefreshError::Fetch { .. } => FetchError::new_err(msg),
        liter_llm::CatalogRefreshError::Parse { .. } => ParseError::new_err(msg),
        liter_llm::CatalogRefreshError::Cache { .. } => CacheError::new_err(msg),
        _ => CatalogRefreshError::new_err(msg),
    }
}
...
fn liter_llm_error_to_py_err(e: liter_llm::LiterLlmError) -> pyo3::PyErr {
    ...
    #[allow(unreachable_patterns)]
    match &e {
        liter_llm::LiterLlmError::Authentication { .. } => {
            AuthenticationError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::RateLimited { .. } => {
            RateLimitedError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::BadRequest { .. } => {
            BadRequestError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::ContextWindowExceeded { .. } => ContextWindowExceededError::new_err((
            msg,
            2u32,
            e.status_code(),
            e.is_transient(),
        ...
        liter_llm::LiterLlmError::ContentPolicy { .. } => {
            ContentPolicyError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::NotFound { .. } => {
            NotFoundError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::ServerError { .. } => {
            ServerError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::ServiceUnavailable { .. } => {
            ServiceUnavailableError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::Timeout => {
            LiterLlmTimeoutError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::Streaming { .. } => {
            StreamingError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::EndpointNotSupported { .. } => EndpointNotSupportedError::new_err((
            msg,
            2u32,
            e.status_code(),
            e.is_transient(),
        ...
        liter_llm::LiterLlmError::InvalidHeader { .. } => {
            InvalidHeaderError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::Serialization(..) => {
            SerializationError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::BudgetExceeded { .. } => {
            BudgetExceededError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::HookRejected { .. } => {
            HookRejectedError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::InternalError { .. } => {
            InternalError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::OutboundForbidden { .. } => {
            OutboundForbiddenError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string()))
        }
        liter_llm::LiterLlmError::IdempotencyConflict { .. } => IdempotencyConflictError::new_err((
            msg,
            2u32,
            e.status_code(),
            e.is_transient(),
        ...
        liter_llm::LiterLlmError::IdempotencyInFlight { .. } => IdempotencyInFlightError::new_err((
            msg,
            2u32,
            e.status_code(),
            e.is_transient(),
        ...
        _ => LiterLlmError::new_err((msg, 2u32, e.status_code(), e.is_transient(), e.error_type().to_string())),
    }
}
...
impl LiterLlmErrorInfo {
    ...
    /// (see the crate's FFI error taxonomy).
    #[getter]
    fn code(&self) -> u32 {
        self.code
    }
...
pub fn _internal_bindings(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<CatalogRefreshConfig>()?;
    ...
    m.add_class::<InFlightLimitConfig>()?;
    ...
    m.add_class::<EmbeddingContentPart>()?;
    ...
    m.add_function(wrap_pyfunction!(clear_catalog_overlay, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(install_catalog_overlay_from_str, m)?)?;
    m.add_function(wrap_pyfunction!(model_info, m)?)?;
    m.add_function(wrap_pyfunction!(record_cost_usd, m)?)?;
    m.add_function(wrap_pyfunction!(refresh_catalog, m)?)?;
    m.add_function(wrap_pyfunction!(register_custom_provider, m)?)?;
    m.add_function(wrap_pyfunction!(unregister_custom_provider, m)?)?;
    m.add("DisabledError", m.py().get_type::<DisabledError>())?;
    m.add("InsecureUrlError", m.py().get_type::<InsecureUrlError>())?;
    m.add("FetchError", m.py().get_type::<FetchError>())?;
    m.add("ParseError", m.py().get_type::<ParseError>())?;
    m.add("CacheError", m.py().get_type::<CacheError>())?;
    m.add("CatalogRefreshError", m.py().get_type::<CatalogRefreshError>())?;
