...
// alef:hash:75b303cbd3917760484f90cae0016d6f16bc3ae34bf6887ffc731ff8ad49e928
...
impl DefaultClient {
    ...
    pub fn speech<'py>(&self, py: Python<'py>, req: CreateSpeechRequest) -> PyResult<Bound<'py, PyAny>> {
        ...
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
            "Not implemented: DefaultClient.speech",
        ))
    }
    ...
    pub fn file_content<'py>(&self, py: Python<'py>, file_id: String) -> PyResult<Bound<'py, PyAny>> {
        let _ = file_id;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
            "Not implemented: DefaultClient.file_content",
        ))
    }
}
