...
// alef:hash:627b4fe9f474ebf0f07b1fedf1d09213145ba781420026641b065bf9b6dfb21c
...
export declare class JsDefaultClient {
	...
	createFile(req: string): Promise<string>;
	retrieveFile(fileId: string): Promise<string>;
	deleteFile(fileId: string): Promise<string>;
	listFiles(query?: string | undefined | null): Promise<string>;
	fileContent(fileId: string): Promise<Uint8Array>;
	createBatch(req: string): Promise<string>;
	retrieveBatch(batchId: string): Promise<string>;
	listBatches(query?: string | undefined | null): Promise<string>;
	cancelBatch(batchId: string): Promise<string>;
	createResponse(req: string): Promise<string>;
	retrieveResponse(id: string): Promise<string>;
	cancelResponse(id: string): Promise<string>;
}
