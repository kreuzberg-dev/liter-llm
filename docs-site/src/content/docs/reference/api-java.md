...
<!-- alef:hash:95ececd9b4df714698674f8c5842a90f87b1e2d5463b17718d1fcd7d937436e6 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Java API Reference <span class="version-badge">v1.19.2</span>
...
| `responseFormat` | `@Nullable ResponseFormat` | `null` | Output format constraint (text, JSON, JSON schema). |
...
| `reasoningEffort` | `@Nullable ReasoningEffort` | `null` | Reasoning effort level (minimal, low, medium, high, max) for extended-thinking models. |
...
| `finishReason` | `@Nullable FinishReason` | `null` | Why the model stopped generating (stop, length, tool_calls, content_filter, etc.). |
...
| `finishReason` | `@Nullable FinishReason` | `null` | Why the stream ended (present only in final chunk). |
...
| `callType` | `@Nullable ToolType` | `null` | Tool type (typically "function"). |
