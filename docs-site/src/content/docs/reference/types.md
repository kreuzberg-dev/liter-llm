...
<!-- alef:hash:95248858477845242d9c3c85a411caae84a51741fe92adc178d290c3298aa428 -->
...
| `metadata` | `HashMap<String, String>` | `HashMap::new()` | Developer-defined tags attached to the completion. |
...
| `headers` | `HashMap<String, String>` | `HashMap::new()` | Extra headers sent on every request. |
| `providers` | `Vec<LlmProviderConfig>` | `vec![]` | Custom provider configurations, in addition to the built-in providers. |
...
|---------|------------|-------------|
| `Text` | `text` | Plain text. — Fields: `text`: `String` |
| `ImageUrl` | `image_url` | Image identified by a data URL or HTTP/HTTPS URL. — Fields: `image_url`: `ImageUrl` |
| `ImageBase64` | `image_base64` | Image encoded as a complete data URL. — Fields: `image_base64`: `String` |
...
| `Multimodal` | Text and image parts for a single multimodal embedding. — Fields: `_0`: `Vec<EmbeddingContentPart>` |
