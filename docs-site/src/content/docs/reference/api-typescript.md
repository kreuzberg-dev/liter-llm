...
<!-- alef:hash:ac9c5bd6471806bed05056ee3893ed9d78984f1dfe379668111bbf9ef43e8dc4 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## TypeScript API Reference <span class="version-badge">v1.18.4</span>
...
```typescript
function recordCostUsd(system: string, model: string, operation: string, costUsd: number): void
```
...
| `Multimodal` | Text and image parts for a single multimodal embedding. — Fields: `0`: `Array<EmbeddingContentPart>` |
