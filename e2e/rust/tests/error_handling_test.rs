...
// alef:hash:6d88eb5ef20bcec3aae2b21cd238bf6aa363dedfec6c51aa51ac1c44b04e8442
...
async fn test_bedrock_error_auth() {
    ...
    assert_eq!(result.error.status_code, 403, "equals assertion failed");
}
...
async fn test_gateway_timeout_504() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().unwrap_err().to_string().contains("ServiceUnavailable"),
        "error message mismatch"
    );
    assert_eq!(result.error.status_code, 504, "equals assertion failed");
}
...
async fn test_server_error_500() {
    ...
    assert_eq!(result.error.status_code, 500, "equals assertion failed");
}
...
async fn test_service_unavailable_502() {
    ...
    assert_eq!(result.error.status_code, 502, "equals assertion failed");
}
...
async fn test_timeout_error() {
    ...
    assert_eq!(result.error.status_code, 408, "equals assertion failed");
}
