...
// alef:hash:bb9338c86c6ee3fb47d6d627684c0bd9579abf7e6c93361c7a87d2033a4dd20c
...
async fn test_anthropic_error_auth() {
    ...
    let request_json = serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "anthropic/claude-3-5-sonnet-20241022"});
...
async fn test_azure_error_auth() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json = serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "azure/gpt-4"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
...
async fn test_bad_request_400() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json =
        serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "gpt-4", "temperature": 5.0});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
...
async fn test_bedrock_error_auth() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json = serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "bedrock/anthropic.claude-3-sonnet-20240229-v1:0"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
...
async fn test_content_policy_violation() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json =
        serde_json::json!({"messages": [{"content": "Generate harmful content", "role": "user"}], "model": "gpt-4"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("ContentPolicy"),
        "error message mismatch"
    );
    // skipped: field 'error.status_code' not available on result type
}
...
async fn test_context_window_exceeded() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json = serde_json::json!({"messages": [{"content": "Very long prompt that exceeds the context window...", "role": "user"}], "model": "gpt-4"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
...
async fn test_github_copilot_error_auth() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json =
        serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "github_copilot/gpt-4o"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
...
async fn test_not_found_404() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json = serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "gpt-99"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
...
async fn test_server_error_500() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("ServerError"),
        "error message mismatch"
    );
    // skipped: field 'error.status_code' not available on result type
}
...
async fn test_timeout_error() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("Timeout"),
        "error message mismatch"
    );
    // skipped: field 'error.status_code' not available on result type
}
...
async fn test_vertex_error_auth() {
    ...
    let mock_server = MockServer::start(vec![mock_route]).await;
    let request_json =
        serde_json::json!({"messages": [{"content": "Hello", "role": "user"}], "model": "vertex_ai/gemini-2.0-flash"});
    let request = serde_json::from_value(request_json).unwrap();
    let client =
        liter_llm::create_client("test-key".to_string(), Some(mock_server.url.clone()), None, None, None).unwrap();
    let result = client.chat(request).await;
