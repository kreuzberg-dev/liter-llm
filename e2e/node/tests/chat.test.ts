...
// alef:hash:8bf737de3a05ad4b370e80dd3c4ca6ca5b27f68c65b3a048705fdaee29950609
	...
	it("developer_message: Chat request that includes a developer role message alongside user messages", async () => {
		...
		const result = await client.chat({
			messages: [
				{
					content:
						"You are a coding assistant. Always respond with concise code examples.",
					role: "developer",
				},
			...
			tools: [
				{
					function: {
						...
						parameters: {
							properties: {
								location: { description: "The city name", type: "string" },
							},
							required: ["location"],
							type: "object",
						},
