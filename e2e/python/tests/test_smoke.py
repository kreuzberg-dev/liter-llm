...
# alef:hash:5d2c6ce00bb9dd9ff04176d086a95ab85758cd8522b7c9ad1ec6c515bc345339
...
async def test_azure_embed() -> None:
    ...
    assert len(result.data.get("0").embedding) == 1480  # noqa: S101
...
async def test_smoke_streaming_openai() -> None:
    ...
    _ = await client.chat_stream(request=request)
