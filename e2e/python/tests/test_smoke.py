...
# alef:hash:25d3426360f9d3e8a6d99d2c012353976a661cb5f35153eee946089970c3fa7e
...
async def test_anthropic_chat() -> None:
    ...
    assert result.choices[0].message.content.strip() == "Hello!"  # noqa: S101
...
async def test_azure_embed() -> None:
    ...
    request = {"input": "Hello world", "model": "azure/text-embedding-ada-002"}
    client = create_client(
        api_key="test-key",
...
async def test_bedrock_chat() -> None:
    ...
    request = {
        "max_tokens": 16,
        "messages": [{"content": "Say hello in one word.", "role": "user"}],
...
async def test_smoke_cache_memory() -> None:
    ...
    request = {
        "max_tokens": 5,
        "messages": [
            {"content": "What is 2+2? Answer with just the number.", "role": "user"}
        ],
...
async def test_smoke_chat_anthropic() -> None:
    ...
    request = {
        "max_tokens": 10,
        "messages": [{"content": "Say hello in exactly one word.", "role": "user"}],
...
async def test_smoke_embed_openai() -> None:
    ...
    request = {"input": ["Hello world"], "model": "openai/text-embedding-3-small"}
    client = create_client(
        api_key="test-key",
...
async def test_smoke_streaming_openai() -> None:
    ...
    request = {
        "max_tokens": 50,
        "messages": [{"content": "Count from 1 to 5.", "role": "user"}],
        "model": "openai/gpt-4o-mini",
    }
    client = create_client(
        api_key="test-key",
...
async def test_vertex_embed() -> None:
    ...
    request = {"input": "Hello", "model": "vertex_ai/text-embedding-005"}
    client = create_client(
        api_key="test-key",
