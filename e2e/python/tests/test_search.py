...
# alef:hash:2172ef3a3f668a818cda05001c7b7514e7523663019a3aa9afb467997afe51f8
...
async def test_search_basic() -> None:
    ...
    request = SearchRequest.from_json(
        '{"model":"brave/web-search","query":"What is Rust programming language?"}'
    )
...
async def test_search_empty_results() -> None:
    ...
    request = SearchRequest.from_json(
        '{"model":"brave/web-search","query":"xyznonexistent12345xyz"}'
    )
    client = create_client(
        api_key="test-key",
...
async def test_search_with_max_results() -> None:
    ...
    request = SearchRequest.from_json(
        '{"max_results":2,"model":"brave/web-search","query":"Rust programming"}'
    )
    client = create_client(
        api_key="test-key",
