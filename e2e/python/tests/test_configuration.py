...
# alef:hash:5cb139f607aa678b4df6ce6626606c00d29955c7c66ccfc9e7b05cc3fb7d0122
...
async def test_custom_base_url() -> None:
    ...
    assert (
        _alef_e2e_text(result.choices[0].message.content).lower() == "Hi there!".lower()
    )  # noqa: S101
...
async def test_local_provider_llamacpp() -> None:
    ...
    assert (
        ...
        == "Hi there! I'm running locally.".lower()
    )  # noqa: S101
    assert _alef_e2e_text(result.choices[0].finish_reason).lower() == "stop".lower()  # noqa: S101
...
async def test_local_provider_ollama() -> None:
    ...
    assert (
        _alef_e2e_text(result.choices[0].message.content).lower()
        == "Hello! How can I help you today?".lower()
    )  # noqa: S101
    assert _alef_e2e_text(result.choices[0].finish_reason).lower() == "stop".lower()  # noqa: S101
...
async def test_local_provider_vllm() -> None:
    ...
    assert (
        _alef_e2e_text(result.choices[0].message.content).lower()
        == "Hello! How may I assist you?".lower()
    )  # noqa: S101
    assert _alef_e2e_text(result.choices[0].finish_reason).lower() == "stop".lower()  # noqa: S101
