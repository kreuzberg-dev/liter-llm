...
# alef:hash:8a37914fe78e75e79632e3fcd4724a33c2ae7ea595a6dc7fe6f3f20513ea9023
...
async def test_developer_message() -> None:
    ...
    assert (
        _alef_e2e_text(result.choices[0].message.content).lower() == "s[::-1]".lower()
    )  # noqa: S101
...
async def test_finish_reason_content_filter() -> None:
    ...
    assert len(result.choices) == 1  # noqa: S101
    assert (
        _alef_e2e_text(result.choices[0].finish_reason).lower()
...
async def test_multi_turn_conversation() -> None:
    ...
    assert len(result.choices) == 1  # noqa: S101
    assert (
        _alef_e2e_text(result.choices[0].message.content).lower()
        == "4 + 4 equals 8.".lower()
    )  # noqa: S101
    assert _alef_e2e_text(result.choices[0].finish_reason).lower() == "stop".lower()  # noqa: S101
...
async def test_parallel_tool_calls() -> None:
    ...
    assert (
        _alef_e2e_text(result.choices[0].finish_reason).lower() == "tool_calls".lower()
    )  # noqa: S101
...
async def test_tool_choice_required() -> None:
    ...
    assert result.choices[0].message.tool_calls  # noqa: S101
    assert (
        _alef_e2e_text(result.choices[0].message.tool_calls[0].function.name).lower()
        == "get_weather".lower()
    )  # noqa: S101
    assert (
        _alef_e2e_text(result.choices[0].finish_reason).lower() == "tool_calls".lower()
