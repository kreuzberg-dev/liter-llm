...
# alef:hash:76d39c5220d80744ee2ed2300628959589a00bfbed622b63cd91dd81c5ef50d6
...
async def test_edge_moderate_empty_input() -> None:
    ...
    request = {"input": "", "model": "omni-moderation-latest"}
    client = create_client(
        api_key="test-key",
...
async def test_error_moderate_auth_401() -> None:
    ...
    request = {"input": "Hello", "model": "omni-moderation-latest"}
    client = create_client(
        api_key="test-key",
        base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/error_moderate_auth_401",
    )
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await client.moderate(request=request)
...
async def test_error_moderate_bad_request() -> None:
    ...
    request = {"input": "Hello", "model": "nonexistent-moderation"}
    client = create_client(
        api_key="test-key",
