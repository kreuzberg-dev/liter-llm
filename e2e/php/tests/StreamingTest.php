...
// alef:hash:86f5e1b92575dfbf15076c5c8ef27dac15891ad7d714a41a2bcf5d2e8409c755
...
final class StreamingTest extends TestCase
{
    ...
    public function test_anthropic_stream(): void
    {
        ...
        $this->assertEquals("One Two Three", trim($result->stream_content));
    ...
    public function test_azure_stream(): void
    {
        ...
        $result = $client->chat_stream_async(null);
        $this->assertGreaterThanOrEqual(3, count($result->chunks));
        $this->assertEquals("1 2 3", trim($result->stream_content));
        $this->assertTrue($result->stream_complete);
    }
    ...
    public function test_empty_stream(): void
    {
        ...
        $this->assertEquals("", trim($result->stream_content));
    }
    ...
    public function test_stream_done_signal(): void
    {
        ...
        $result = $client->chat_stream_async(null);
        $this->assertTrue($result->stream_complete);
        $this->assertEquals("Done", trim($result->stream_content));
    ...
    public function test_stream_with_tool_calls(): void
    {
        ...
        $this->assertEquals("tool_calls", trim($result->finish_reason));
        $this->assertNotEmpty($result->tool_calls);
        $this->assertEquals("get_weather", trim($result->tool_calls["0"]->function->name));
    }
    ...
    public function test_stream_with_usage(): void
    {
        ...
        $result = $client->chat_stream_async(null);
        $this->assertGreaterThanOrEqual(3, count($result->chunks));
        $this->assertEquals("Hi there!", trim($result->stream_content));
        $this->assertEquals(18, trim($result->usage->total_tokens));
    }
