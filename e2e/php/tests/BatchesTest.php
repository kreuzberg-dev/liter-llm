...
// alef:hash:538ebb5677ae9b2a85167cc40687a39cec2d341fb48cb33a2eda10429d5391cc
...
final class BatchesTest extends TestCase
{
    ...
    public function test_edge_batch_already_cancelled(): void
    {
        ...
        $client->cancelBatchAsync("batch-cancelled001");
    }
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->listBatchesAsync();
    ...
    public function test_error_batch_not_found(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $this->expectException(\Exception::class);
        $client->retrieveBatchAsync("batch-nonexistent");
    }
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->retrieveBatchAsync("batch-ghi789");
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->cancelBatchAsync("batch-def456");
        $this->assertNotEmpty($result->id);
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->createBatchAsync(null);
        $this->assertNotEmpty($result->id);
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->retrieveBatchAsync("batch-abc123");
        $this->assertNotEmpty($result->id);
