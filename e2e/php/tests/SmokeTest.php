...
// alef:hash:93e6bfa0c489c6c641161d56f0c4cc41247aaa55f606848a298964f72f121f6d
...
final class SmokeTest extends TestCase
{
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->listModelsAsync(["model" => "ollama/any"]);
        $this->assertGreaterThanOrEqual(1, count($result->data));
    }
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->listModelsAsync(["model" => "openai/gpt-4o-mini"]);
        $this->assertGreaterThanOrEqual(1, count($result->data));
    }
    ...
    {
        $client = \Liter\Llm\LiterLlm::createClient('test-key');
        $result = $client->embedAsync(json_encode("Hello"));
        $this->assertCount(1, $result->data);
