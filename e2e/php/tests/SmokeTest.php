...
// alef:hash:03270a0fa2a3c66637aa2a159cc9a10bbe134f283255664bf7c7f0aa0f07dda0
...
final class SmokeTest extends TestCase
{
    ...
    public function test_anthropic_chat(): void
    {
        ...
        $this->assertEquals(23, trim($result->usage->total_tokens));
    }
    ...
    public function test_azure_chat(): void
    {
        ...
        $this->assertEquals(13, trim($result->usage->total_tokens));
    }
    ...
    public function test_basic_chat(): void
    {
        ...
        $this->assertEquals("Hello!", trim($result->choices["0"]->message->content));
        $this->assertEquals("stop", trim($result->choices["0"]->finish_reason));
        $this->assertEquals(15, trim($result->usage->total_tokens));
        $this->assertEquals("gpt-4", trim($result->model));
    }
    ...
    public function test_github_copilot_chat(): void
    {
        ...
        $this->assertEquals(14, trim($result->usage->total_tokens));
    }
