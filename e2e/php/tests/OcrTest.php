...
// alef:hash:55b113669c4fc38a3560e0b276ab42cc46f70a927ba6b63754957587dbf9a225
...
final class OcrTest extends TestCase
{
    ...
    public function test_ocr_multi_page(): void
    {
        ...
        $this->assertEquals(0, trim($result->pages["0"]->index));
        $this->assertEquals(1, trim($result->pages["1"]->index));
    }
