...
// alef:hash:1d8b12fb77999bec791b8f510a32f4cc80c57c9d4a7b6990dacb7dbb960ef374
...
final class EmbedTest extends TestCase
{
    ...
    public function test_edge_embed_batch_input(): void
    {
        ...
        $this->assertCount(2, $result->data);
        $this->assertEquals(0, trim($result->data["0"]->index));
        $this->assertEquals(1, trim($result->data["1"]->index));
    }
