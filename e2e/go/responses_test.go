...
// alef:hash:61f4eaa90d94c80da7ce2fc47a43feab1959f40a6e83df1e327883c36faee437
...
func Test_EdgeResponseEmptyOutput(t *testing.T) {
	...
	result, err := client.CreateResponse(``)
	if err != nil {
...
func Test_ErrorResponseAuth401(t *testing.T) {
	...
	_, err := client.CreateResponse(`Hello`)
	if err == nil {
...
func Test_SmokeCancelResponse(t *testing.T) {
	...
	result, err := client.CancelResponse("")
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result.ID) == 0 {
...
func Test_SmokeCreateResponse(t *testing.T) {
	...
	result, err := client.CreateResponse(`Explain quantum computing in one sentence.`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result.ID) == 0 {
...
func Test_SmokeResponseWithTools(t *testing.T) {
	...
	result, err := client.CreateResponse(`What is the weather in San Francisco?`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result.ID) == 0 {
...
func Test_SmokeRetrieveResponse(t *testing.T) {
	...
	result, err := client.RetrieveResponse("")
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result.ID) == 0 {
