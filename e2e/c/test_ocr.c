...
// alef:hash:dd375236dea3ab65ee59f64a6639b0c73b5eb9ab267fcb78b6913608e166fe06
...
void test_ocr_multi_page(void) {
    ...
    char* pages_0_index = alef_json_get_string(pages_json, "0");
    char* pages_1_index = alef_json_get_string(pages_json, "1");
    {
    ...
    assert(strcmp(pages_0_index, 0) == 0 && "equals assertion failed");
    assert(strcmp(pages_1_index, 1) == 0 && "equals assertion failed");
