 ...
 * alef:hash:cd9530c966c5dde4027c5068ab3e38bfcb62d2cd7b6adb0e09e11b8cbaed7b22
...
void test_list_models_filtered(void) {
    ...
    assert(data_0_object != NULL && strcmp(data_0_object, "model") == 0 && "equals assertion failed");
    literllm_free_string(data);
    free(data_0_object);
    free(data_0_json);
