...
// alef:hash:e3c6e43cdde0d910977bc67dede1fb84a8d78816bd08cbb5ac50b6e31bd815aa
// To regenerate: alef generate
// To verify freshness: alef verify

import { describe, expect, it } from "vitest";
import { createClient, WasmChatCompletionRequest, WasmSearchRequest, WasmChatCompletionTool, WasmFunctionDefinition, WasmStreamOptions } from "@xberg-io/liter-llm-wasm";
...
describe("search", () => {
	...
	it("search_basic: Basic web search request with a simple query", async () => {
		...
		const result = await client.search((() => { const _u0 = WasmSearchRequest.default(); _u0.model = "brave/web-search"; _u0.query = "What is Rust programming language?"; return _u0; })());
	...
	it("search_empty_results: Web search with a query that returns no results", async () => {
		...
		const result = await client.search((() => { const _u0 = WasmSearchRequest.default(); _u0.model = "brave/web-search"; _u0.query = "xyznonexistent12345xyz"; return _u0; })());
    expect(result).toBeDefined();
