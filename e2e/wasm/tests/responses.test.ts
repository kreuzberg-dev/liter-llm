...
// alef:hash:dc9afbd968868b253cce38bcc3bb78833f6cbd31415afc4a55b0668d7d1486da
...
describe("responses", () => {
  ...
  it("error_response_auth_401: 401 Unauthorized when creating a response with invalid API key", async () => {
    ...
    await expect(async () => {
      await client.createResponse({ input: "Hello", model: "gpt-4o" } as WasmChatCompletionRequest);
    }).rejects.toThrow();
  });
