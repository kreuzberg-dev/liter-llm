...
```go
func (o *DefaultClient) CreateFile(req string) (string, error)
```
...
```go
func (o *DefaultClient) RetrieveFile(fileId string) (string, error)
```
...
```go
func (o *DefaultClient) DeleteFile(fileId string) (string, error)
```
...
```go
func (o *DefaultClient) ListFiles(query string) (string, error)
```
...
```go
func (o *DefaultClient) CreateBatch(req string) (string, error)
```
...
```go
func (o *DefaultClient) RetrieveBatch(batchId string) (string, error)
```
...
```go
func (o *DefaultClient) ListBatches(query string) (string, error)
```
...
```go
func (o *DefaultClient) CancelBatch(batchId string) (string, error)
```
...
```go
func (o *DefaultClient) CreateResponse(req string) (string, error)
```
...
```go
func (o *DefaultClient) RetrieveResponse(id string) (string, error)
```
...
```go
func (o *DefaultClient) CancelResponse(id string) (string, error)
```
