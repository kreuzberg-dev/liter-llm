...
```csharp
public async Task<string> CreateFileAsync(string req)
```
...
```csharp
public async Task<string> ListFilesAsync(string query)
```
...
```csharp
public async Task<string> CreateBatchAsync(string req)
```
...
```csharp
public async Task<string> RetrieveBatchAsync(string batchId)
```
...
```csharp
public async Task<string> ListBatchesAsync(string query)
```
...
```csharp
public async Task<string> CancelBatchAsync(string batchId)
```
...
```csharp
public async Task<string> CreateResponseAsync(string req)
```
...
```csharp
public async Task<string> RetrieveResponseAsync(string id)
```
...
```csharp
public async Task<string> CancelResponseAsync(string id)
```
