...
```php
public function createFile(string $req): string
```
...
```php
public function deleteFile(string $fileId): string
```
...
```php
public function listFiles(string $query): string
```
...
```php
public function createBatch(string $req): string
```
...
```php
public function retrieveBatch(string $batchId): string
```
...
```php
public function listBatches(string $query): string
```
...
```php
public function cancelBatch(string $batchId): string
```
...
```php
public function createResponse(string $req): string
```
...
```php
public function retrieveResponse(string $id): string
```
...
```php
public function cancelResponse(string $id): string
```
