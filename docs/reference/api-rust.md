...
```rust
pub fn create_file(&self, req: &str) -> String
```
...
```rust
pub fn retrieve_file(&self, file_id: &str) -> String
```
...
```rust
pub fn delete_file(&self, file_id: &str) -> String
```
...
```rust
pub fn list_files(&self, query: Option<String>) -> String
```
...
```rust
pub fn create_batch(&self, req: &str) -> String
```
...
```rust
pub fn retrieve_batch(&self, batch_id: &str) -> String
```
...
```rust
pub fn list_batches(&self, query: Option<String>) -> String
```
...
```rust
pub fn cancel_batch(&self, batch_id: &str) -> String
```
...
```rust
pub fn create_response(&self, req: &str) -> String
```
...
```rust
pub fn retrieve_response(&self, id: &str) -> String
```
...
```rust
pub fn cancel_response(&self, id: &str) -> String
```
